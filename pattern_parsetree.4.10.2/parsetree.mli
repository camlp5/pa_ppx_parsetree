...
type constant =
  ...
  *)
  ...
  (* 'c' *)
  | Pconst_string of string Ploc.vala * string Ploc.vala option
  (* "constant"
...
(*-*)  | Ppat_xtr of string loc
  ...
  | Ppat_tuple of pattern list Ploc.vala
        (* (P1, ..., Pn)
           ...
           Invariant: n >= 2
        *)
  | Ppat_construct of Longident.t Ploc.vala loc * pattern option Ploc.vala
        (* C                    None
           C P              Some P
...
and type_extension =
    {
     ...
     ptyext_params: (core_type * variance) list Ploc.vala;
...
and 'a class_infos =
    {
     ...
     pci_params: (core_type * variance) list Ploc.vala;

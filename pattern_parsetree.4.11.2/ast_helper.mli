...
(*-*)    val attrs:pattern -> attributes -> pattern
    ...
    val construct: ?loc:loc -> ?attrs:attrs -> lid_vala -> pattern option Ploc.vala -> pattern
...
module Type:
  sig
    ...
    val constructor: ?loc:loc -> ?attrs:attrs -> ?info:info ->
      ?args:constructor_arguments -> res:core_type option Ploc.vala -> str_vala ->
...
module Te:
  sig
    val mk: ?loc:loc -> ?attrs:attrs -> ?docs:docs ->
      ?params:(core_type * variance) list Ploc.vala -> ?priv:private_flag Ploc.vala ->
      lid_vala -> extension_constructor Ploc.vala list Ploc.vala -> type_extension
...
module Ci:
  sig
    val mk: ?loc:loc -> ?attrs:attrs -> ?docs:docs -> ?text:text ->
      ?virt:virtual_flag Ploc.vala -> ?params:(core_type * variance) list Ploc.vala ->

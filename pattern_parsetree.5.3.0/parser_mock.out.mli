...
val wrap_exp_attrs :
  ...
  Parsetree.attribute list Ast_helper.vala -> Parsetree.expression
val mkexp_attrs :
  loc:Lexing.position * Lexing.position ->
...
val wrap_typ_attrs :
  ...
  Parsetree.core_type ->
  string Ploc.vala Asttypes.loc option *
  Parsetree.attribute list Ast_helper.vala -> Parsetree.core_type
val wrap_pat_attrs :
  loc:Lexing.position * Lexing.position ->
  Parsetree.pattern ->
  string Ploc.vala Asttypes.loc option *
  Parsetree.attribute list Ast_helper.vala -> Parsetree.pattern
val mkpat_attrs :
  loc:Lexing.position * Lexing.position ->
...
val xv_mkpat___anonymous_34_ : Parsetree.pattern
val xv_mkpat___anonymous_31_ : Parsetree.pattern
val xv_mkpat___anonymous_30_ : Parsetree.pattern
val xv_mkpat___anonymous_29_pattern_no_exn__ : Parsetree.pattern
val xv_mkpat___anonymous_29_pattern__ : Parsetree.pattern
...
val xv___anonymous_34 : Parsetree.pattern_desc
...
val xv___anonymous_29_pattern_no_exn_ : Parsetree.pattern_desc
val xv___anonymous_29_pattern_ : Parsetree.pattern_desc

...
val wrap_exp_attrs :
  loc:Lexing.position * Lexing.position ->
  Parsetree.expression ->
  string Asttypes.loc option * Parsetree.attribute list ->
  Parsetree.expression
val mkexp_attrs :
  loc:Lexing.position * Lexing.position ->
...
val wrap_pat_attrs :
  loc:Lexing.position * Lexing.position ->
  Parsetree.pattern ->
  string Asttypes.loc option * Parsetree.attribute list -> Parsetree.pattern
val mkpat_attrs :
  loc:Lexing.position * Lexing.position ->
...
val wrap_str_ext :
  ...
  string Asttypes.loc option -> Parsetree.structure_item
val wrap_mkstr_ext :
  loc:Lexing.position * Lexing.position ->
...
val wrap_sig_ext :
  ...
  string Asttypes.loc option -> Parsetree.signature_item
val wrap_mksig_ext :
  loc:Lexing.position * Lexing.position ->
...
val xv_mkrhs___anonymous_33_ : Longident.t Asttypes.loc
val xv_mkrhs___anonymous_32_ : Longident.t Asttypes.loc
val xv_mkrhs___anonymous_28_ : Longident.t Asttypes.loc
...
val xv_ioption___anonymous_21_ : Longident.t option
...
val xv___anonymous_33 : Longident.t

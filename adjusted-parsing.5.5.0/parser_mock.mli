...
val pstr_type :
  (Asttypes.rec_flag * 'a) * Parsetree.type_declaration list ->
...
val pstr_class :
  'a * Parsetree.class_declaration list -> Parsetree.structure_item_desc * 'a
val pstr_class_type :
  'a * Parsetree.class_type_declaration list ->
  Parsetree.structure_item_desc * 'a
val psig_extension :
  Parsetree.extension ->
...
val psig_recmodule :
  'a * Parsetree.module_declaration list ->
  Parsetree.signature_item_desc * 'a
val psig_modtype :
  Parsetree.module_type_declaration * 'a ->
  Parsetree.signature_item_desc * 'a
...
val psig_class :
  'a * Parsetree.class_description list -> Parsetree.signature_item_desc * 'a
val psig_class_type :
  'a * Parsetree.class_type_declaration list ->
  Parsetree.signature_item_desc * 'a
val mkctf :
...
val ldot :
  ...
  string -> Lexing.position * Lexing.position -> Longident.t
...
val lapply :
  ...
  Longident.t ->
  Lexing.position * Lexing.position ->
  Longident.t -> Lexing.position * Lexing.position -> Longident.t
...
val mk_newtypes :
  loc:Lexing.position * Lexing.position ->
  string Asttypes.loc list -> Parsetree.expression -> Parsetree.expression
...
val pexp_extension :
  loc:Lexing.position * Lexing.position ->
  id:string Asttypes.loc -> Parsetree.expression -> Parsetree.expression_desc
val mkexp_attrs :
  loc:Lexing.position * Lexing.position ->
  Parsetree.expression_desc ->
  string Asttypes.loc option * Ast_helper.attrs -> Parsetree.expression
val mktyp_attrs :
  loc:Lexing.position * Lexing.position ->
  Parsetree.core_type_desc ->
  string Asttypes.loc option * Ast_helper.attrs -> Parsetree.core_type
val mkpat_attrs :
  loc:Lexing.position * Lexing.position ->
  Parsetree.pattern_desc ->
  string Asttypes.loc option * Ast_helper.attrs -> Parsetree.pattern
...
val wrap_mkstr_ext :
  loc:Lexing.position * Lexing.position ->
  Parsetree.structure_item_desc * string Asttypes.loc option ->
...
val all_params_as_newtypes :
  ...
  (string Asttypes.loc * Location.t) list option
val mkghost_newtype_function_body :
  (string Asttypes.loc * Location.t) list ->
...
val xv_xlist_rec_module_declaration_and_module_declaration_ :
  string Asttypes.loc option * Parsetree.module_declaration list
val xv_xlist_rec_module_binding_and_module_binding_ :
  string Asttypes.loc option * Parsetree.module_binding list
val xv_xlist_generic_type_declaration_nonrec_flag_type_kind__generic_and_type_declaration_type_kind__ :
  (Asttypes.rec_flag * string Asttypes.loc option) *
  Parsetree.type_declaration list
val xv_xlist_generic_type_declaration_no_nonrec_flag_type_subst_kind__generic_and_type_declaration_type_subst_kind__ :
  (Asttypes.rec_flag * string Asttypes.loc option) *
  Parsetree.type_declaration list
...
val xv_xlist_class_description_and_class_description_ :
  string Asttypes.loc option * Parsetree.class_description list
val xv_xlist_class_declaration_and_class_declaration_ :
  string Asttypes.loc option * Parsetree.class_declaration list
...
val xv_type_extension_extension_constructor_declaration_ :
  Parsetree.type_extension * string Asttypes.loc option
...
val xv_terminated_core_type_EQUAL_ : Parsetree.core_type
...
val xv_structure : Parsetree.structure
...
val xv_simple_expr_attrs :
  Parsetree.expression_desc * (string Asttypes.loc option * Ast_helper.attrs)
...
val xv_signature : Parsetree.signature
...
val xv_rec_module_declaration :
  string Asttypes.loc option * Parsetree.module_declaration
val xv_rec_module_bindings :
  string Asttypes.loc option * Parsetree.module_binding list
val xv_rec_module_binding :
  string Asttypes.loc option * Parsetree.module_binding
val xv_rec_flag : Asttypes.rec_flag
val xv_raw_string : string
val xv_qualified_dotop : Longident.t option * string
val xv_proper_tuple_type :
  Parsetree.core_type * (string option * Parsetree.core_type) list
...
val xv_object_expr_field : Asttypes.label Asttypes.loc * Parsetree.expression
...
val xv_nonempty_list_mkrhs_LIDENT__ : string Asttypes.loc list
...
val xv_module_name_ : string option
...
val xv_module_declaration :
  Parsetree.module_declaration * string Asttypes.loc option
val xv_module_binding_body : Parsetree.module_expr
val xv_module_binding : Parsetree.module_binding * string Asttypes.loc option
val xv_module_alias :
  Parsetree.module_declaration * string Asttypes.loc option
...
val xv_mkrhs_ident_ : string Asttypes.loc
...
val xv_mkrhs___anonymous_32_ : Longident.t Asttypes.loc
val xv_mkrhs___anonymous_31_ : Longident.t Asttypes.loc
val xv_mkrhs___anonymous_27_ : Longident.t Asttypes.loc
val xv_mkrhs___anonymous_26_ : Longident.t Asttypes.loc
...
val xv_mkloc___anonymous_44_ : Ast_helper.str
...
val xv_mk_longident_mod_ext_longident___anonymous_43_ : Longident.t
...
val xv_lident_list : string Asttypes.loc list
...
val xv_labeled_tuple_typ_element : string option * Parsetree.core_type
...
val xv_labeled_tuple_pat_element_noprec_pattern_no_exn_ :
  string option * Parsetree.pattern
...
val xv_labeled_tuple_pat_element_pattern_no_exn_ :
  string option * Parsetree.pattern
val xv_labeled_tuple_pat_element_pattern_ : string option * Parsetree.pattern
val xv_labeled_tuple_element : string option * Parsetree.expression
val xv_labeled_tuple : (string option * Parsetree.expression) list
...
val xv_include_statement_module_type_ :
  Parsetree.include_description * string Asttypes.loc option
val xv_include_statement_module_expr_ :
  Parsetree.include_declaration * string Asttypes.loc option
val xv_implementation : Parsetree.structure
...
val xv_generic_type_declarations_no_nonrec_flag_type_subst_kind_ :
  (Asttypes.rec_flag * string Asttypes.loc option) *
  Parsetree.type_declaration list
val xv_generic_type_declaration_nonrec_flag_type_kind_ :
  (Asttypes.rec_flag * string Asttypes.loc option) *
...
val xv_extra_str_append_optional_structure_standalone_expression_flatten_list_structure_element____ :
  Parsetree.structure
val xv_extra_sig_flatten_list_signature_element___ : Parsetree.signature
...
val xv_ext_attributes : string Asttypes.loc option * Ast_helper.attrs
...
val xv_class_type_declaration :
  string Asttypes.loc option * Parsetree.class_type_declaration
...
val xv_class_description :
  string Asttypes.loc option * Parsetree.class_description
val xv_class_declarations :
  string Asttypes.loc option * Parsetree.class_declaration list
val xv_class_declaration :
  string Asttypes.loc option * Parsetree.class_declaration
...
val xv___anonymous_5 :
  Parsetree.signature_item_desc * string Asttypes.loc option
val xv___anonymous_44 : string
val xv___anonymous_43 : Asttypes.label
...
val xv___anonymous_32 : Longident.t
val xv___anonymous_31 : Longident.t
...
val xv___anonymous_26 : Longident.t
...
val xv___anonymous_20 : Longident.t

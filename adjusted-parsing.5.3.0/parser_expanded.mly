...
reversed_separated_nontrivial_llist_COMMA_expr_:
  xs = reversed_separated_nontrivial_llist_COMMA_expr_ _2 = COMMA _1 = fun_expr
    {let x =
  let _1 = ( _1 ) in
  ( _1 )
in
( x :: xs )}
| xs = reversed_separated_nontrivial_llist_COMMA_expr_ _2 = COMMA _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs_inlined1 = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let x =
...
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name none___anonymous_21]
...
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name some___anonymous_21]

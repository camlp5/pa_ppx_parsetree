...
val mkconst :
  loc:Lexing.position * Lexing.position ->
  Parsetree.constant_desc -> Parsetree.constant
val pstr_extension :
  Parsetree.extension ->
  Parsetree.attributes -> Parsetree.structure_item_desc * 'a option
val pstr_attribute :
  Parsetree.attribute -> Parsetree.structure_item_desc * 'a option
val pstr_typext :
...
val pstr_module :
  Parsetree.module_binding * 'a -> Parsetree.structure_item_desc * 'a
val pstr_recmodule :
  'a * Parsetree.module_binding list Ploc.vala ->
  Parsetree.structure_item_desc * 'a
val pstr_modtype :
  Parsetree.module_type_declaration * 'a ->
  Parsetree.structure_item_desc * 'a
val pstr_open :
  Parsetree.open_declaration * 'a -> Parsetree.structure_item_desc * 'a
val pstr_class :
  'a * Parsetree.class_declaration list Ploc.vala ->
  Parsetree.structure_item_desc * 'a
val pstr_class_type :
  'a * Parsetree.class_type_declaration list Ploc.vala ->
  Parsetree.structure_item_desc * 'a
val psig_extension :
  Parsetree.extension ->
  Parsetree.attributes -> Parsetree.signature_item_desc * 'a option
val psig_attribute :
  Parsetree.attribute -> Parsetree.signature_item_desc * 'a option
val psig_typext :
...
val psig_module :
  Parsetree.module_declaration * 'a -> Parsetree.signature_item_desc * 'a
val psig_modsubst :
  Parsetree.module_substitution * 'a -> Parsetree.signature_item_desc * 'a
val psig_recmodule :
  'a * Parsetree.module_declaration list Ploc.vala ->
  Parsetree.signature_item_desc * 'a
val psig_modtype :
  Parsetree.module_type_declaration * 'a ->
  Parsetree.signature_item_desc * 'a
val psig_modtypesubst :
  ...
  Parsetree.signature_item_desc * 'a
val psig_open :
  Parsetree.open_description * 'a -> Parsetree.signature_item_desc * 'a
val psig_class :
  'a * Parsetree.class_description list Ploc.vala ->
  Parsetree.signature_item_desc * 'a
val psig_class_type :
  'a * Parsetree.class_type_declaration list Ploc.vala ->
  Parsetree.signature_item_desc * 'a
...
val ldot :
  Longident.t Ploc.vala ->
  Lexing.position * Lexing.position ->
  string Ploc.vala -> Lexing.position * Lexing.position -> Longident.t
...
val mkuminus :
  sloc:Lexing.position * Lexing.position ->
...
val mk_attr :
  loc:Ast_helper.loc ->
  Ast_helper.str_vala -> Parsetree.payload -> Parsetree.attribute
val mkexp_cons_desc :
  Lexing.position * Lexing.position ->
...
val mkexp_desc_constraint :
  Parsetree.expression ->
  Parsetree.type_constraint -> Parsetree.expression_desc
val mkexp_constraint :
  loc:Lexing.position * Lexing.position ->
  Parsetree.expression -> Parsetree.type_constraint -> Parsetree.expression
val mkexp_opt_constraint :
  loc:Lexing.position * Lexing.position ->
  Parsetree.expression ->
  Parsetree.type_constraint option -> Parsetree.expression
...
val lapply :
  ...
  Longident.t Ploc.vala ->
  Lexing.position * Lexing.position ->
  Longident.t Ploc.vala -> Lexing.position * Lexing.position -> Longident.t
...
val pexp_extension :
  loc:Lexing.position * Lexing.position ->
  id:string Ploc.vala Asttypes.loc ->
  Parsetree.expression Ploc.vala -> Parsetree.expression_desc
val mkexp_attrs :
  loc:Lexing.position * Lexing.position ->
  Parsetree.expression_desc ->
  string Ploc.vala Asttypes.loc option * Ast_helper.attrs ->
  Parsetree.expression
val mktyp_attrs :
  loc:Lexing.position * Lexing.position ->
...
val wrap_class_attrs :
  ...
  Parsetree.attribute list Ast_helper.vala -> Parsetree.class_expr
val wrap_mod_attrs :
  loc:'a ->
  Parsetree.attribute list Ast_helper.vala ->
...
val mk_quotedext :
  loc:Lexing.position * Lexing.position ->
  'a * Location.t * string * Ast_helper.loc * string option ->
  'a Ast_helper.vala Location.loc * Parsetree.payload
val text_str : 'a -> 'b list
val text_sig : 'a -> 'b list
val text_cstr : 'a -> 'b list
val text_csig : 'a -> 'b list
val text_def : 'a -> Parsetree.toplevel_phrase list
val extra_text : 'a -> 'b -> 'c -> 'd -> 'd
val extra_str : 'a -> 'b -> 'c -> 'c
val extra_sig : 'a -> 'b -> 'c -> 'c
val extra_cstr : 'a -> 'b -> 'c -> 'c
val extra_csig : 'a -> 'b -> 'c -> 'c
val extra_def : 'a -> 'b -> 'c -> 'c
val extra_rhs_core_type : 'a -> pos:'b -> 'a
type let_binding = {
...
val all_params_as_newtypes :
  Parsetree.function_param list ->
  (string Ploc.vala Asttypes.loc * Location.t) list option
val mkghost_newtype_function_body :
  (string Ploc.vala Asttypes.loc * Location.t) list ->
  Parsetree.type_constraint Ploc.vala option Ploc.vala ->
  Parsetree.expression -> Parsetree.expression_desc
val mkfunction :
  Parsetree.function_param list Ploc.vala ->
  Parsetree.type_constraint Ploc.vala option Ploc.vala ->
  Parsetree.function_body -> Parsetree.expression_desc
val mk_functor_typ :
  (Lexing.position * Parsetree.functor_parameter Ploc.vala) list ->
  Parsetree.module_type -> Parsetree.module_type
val package_type_of_module_type :
  Parsetree.module_type ->
  (Longident.t Ploc.vala Asttypes.loc *
   (Longident.t Ploc.vala Asttypes.loc * Parsetree.core_type) list
   Ast_helper.vala) *
...
val xv_xlist_vala_generic_type_declaration_no_nonrec_flag_type_subst_kind__generic_and_type_declaration_type_subst_kind__ :
  (Asttypes.rec_flag * string Ploc.vala Asttypes.loc option) *
  Parsetree.type_declaration list Ast_helper.vala
val xv_xlist_rec_module_declaration_and_module_declaration_ :
  string Ploc.vala Asttypes.loc option * Parsetree.module_declaration list
val xv_xlist_rec_module_binding_and_module_binding_ :
  string Ploc.vala Asttypes.loc option * Parsetree.module_binding list
...
val xv_xlist_class_description_and_class_description_ :
  string Ploc.vala Asttypes.loc option * Parsetree.class_description list
val xv_xlist_class_declaration_and_class_declaration_ :
  string Ploc.vala Asttypes.loc option * Parsetree.class_declaration list
val xv_wrap_mkstr_ext___anonymous_2_ : Parsetree.structure_item
val xv_wrap_mkstr_ext___anonymous_1_ : Parsetree.structure_item
val xv_wrap_mksig_ext___anonymous_5_ : Parsetree.signature_item
...
val xv_vaval_type_parameters_ :
  ...
  Ast_helper.vala
val xv_vaval_type_constraint_ : Parsetree.type_constraint Ast_helper.vala
...
val xv_vaval_attributes_ : Parsetree.attribute list Ast_helper.vala
...
val xv_value_description :
  Parsetree.value_description * string Ploc.vala Asttypes.loc option
...
val xv_vala_val_longident_ANTI_LONGLID_ : Longident.t Ast_helper.vala
val xv_vala_val_ident_ANTI_LID_ : Asttypes.label Ast_helper.vala
val xv_vala_typevar_list_ANTI_LIST_ :
  Asttypes.label Ast_helper.vala Asttypes.loc list Ast_helper.vala
val xv_vala_type_parameters_ANTI_LIST_ :
  (Parsetree.core_type * (Asttypes.variance * Asttypes.injectivity)) list
  Ast_helper.vala
val xv_vala_type_longident_ANTI_LONGLID_ : Longident.t Ast_helper.vala
...
val xv_vala_post_item_attributes_ANTI_ITEMATTRS_ :
  Parsetree.attribute list Ast_helper.vala
...
val xv_vala_option_preceded_AS_mkrhs_lident_vala____ANTI_OPT_ :
...
val xv_vala_module_name__ANTI_OPT_ :
  Asttypes.label Ast_helper.vala option Ast_helper.vala
...
val xv_vala_match_cases_ANTI_CASES_ : Parsetree.case list Ast_helper.vala
val xv_vala_lident_list_ANTI_LIST_ :
  string Ploc.vala Asttypes.loc list Ast_helper.vala
val xv_vala_label_longident_ANTI_LONGLID_ : Longident.t Ast_helper.vala
...
val xv_vala_fun_params_ANTI_LIST_ :
  Parsetree.function_param list Ast_helper.vala
val xv_vala_formal_class_parameters_ANTI_LIST_ :
  (Parsetree.core_type * (Asttypes.variance * Asttypes.injectivity)) list
  Ast_helper.vala
...
val xv_vala_bar_llist_extension_constructor__ANTI_LIST_ :
  Parsetree.extension_constructor list Ast_helper.vala
val xv_vala_attributes_ANTI_ALGATTRS_ :
  Parsetree.attribute list Ast_helper.vala
...
val xv_vaant_ANTI_TUPLELIST_ :
  (string Ploc.vala option Ploc.vala * Parsetree.expression) list
  Ast_helper.vala
...
val xv_uident_vala : Asttypes.label Ast_helper.vala
val xv_typevar_list : Asttypes.label Ast_helper.vala Asttypes.loc list
...
val xv_type_extension_extension_constructor_declaration_ :
  Parsetree.type_extension * string Ploc.vala Asttypes.loc option
val xv_type_extension_extension_constructor_ :
  Parsetree.type_extension * string Ploc.vala Asttypes.loc option
val xv_type_declarations :
  (Asttypes.rec_flag Ast_helper.vala * string Ploc.vala Asttypes.loc option) *
  Parsetree.type_declaration list Ast_helper.vala
val xv_type_constraint : Parsetree.type_constraint
...
val xv_str_exception_declaration :
  Parsetree.type_exception * string Ploc.vala Asttypes.loc option
...
val xv_separated_nonempty_llist_STAR_labeled_tuple_typ_element_ :
  (Asttypes.label Ast_helper.vala option Ast_helper.vala *
   Parsetree.core_type)
  list
...
val xv_reversed_separated_nontrivial_llist_COMMA_core_type_ :
  Parsetree.core_type list
val xv_reversed_separated_nonempty_llist_STAR_labeled_tuple_typ_element_ :
  (Asttypes.label Ast_helper.vala option Ast_helper.vala *
   Parsetree.core_type)
  list
...
val xv_reversed_nonempty_concat_fun_param_as_list_ :
  Parsetree.function_param list
val xv_reversed_llist_preceded_CONSTRAINT_constrain__ :
  (Parsetree.core_type * Parsetree.core_type * Ast_helper.loc) list
val xv_reversed_labeled_tuple_pattern_pattern_no_exn_ :
  Asttypes.closed_flag *
  (Asttypes.label Ast_helper.vala option Ast_helper.vala * Parsetree.pattern)
  list
val xv_reversed_labeled_tuple_pattern_pattern_ :
  Asttypes.closed_flag *
  (Asttypes.label Ast_helper.vala option Ast_helper.vala * Parsetree.pattern)
  list
val xv_reversed_labeled_tuple_body :
  (Asttypes.label Ast_helper.vala option Ast_helper.vala *
   Parsetree.expression)
  list
...
val xv_rev_reversed_separated_nontrivial_llist_COMMA_core_type__ :
  Parsetree.core_type list
val xv_rev_reversed_separated_nonempty_llist_STAR_labeled_tuple_typ_element__ :
  (Asttypes.label Ast_helper.vala option Ast_helper.vala *
   Parsetree.core_type)
  list
...
val xv_rev_reversed_preceded_or_separated_nonempty_llist_BAR_match_case__ :
  Parsetree.case list
val xv_rev_reversed_nonempty_llist_typevar__ :
  Asttypes.label Ast_helper.vala Asttypes.loc list
...
val xv_rev_reversed_nonempty_llist_labeled_simple_expr__ :
  (Asttypes.arg_label * Parsetree.expression) list
val xv_rev_reversed_nonempty_concat_fun_param_as_list__ :
  Parsetree.function_param list
val xv_rev_reversed_llist_preceded_CONSTRAINT_constrain___ :
  (Parsetree.core_type * Parsetree.core_type * Ast_helper.loc) list
val xv_rev_reversed_labeled_tuple_body_ :
  (Asttypes.label Ast_helper.vala option Ast_helper.vala *
   Parsetree.expression)
  list
...
val xv_rec_module_declaration :
  string Ploc.vala Asttypes.loc option * Parsetree.module_declaration
val xv_rec_module_bindings :
  string Ploc.vala Asttypes.loc option *
  Parsetree.module_binding list Ast_helper.vala
val xv_rec_module_binding :
  string Ploc.vala Asttypes.loc option * Parsetree.module_binding
val xv_rec_flag_vala : Asttypes.rec_flag Ast_helper.vala
...
val xv_preceded_COLON_atomic_type_ : Parsetree.core_type
val xv_preceded_AS_mkrhs_lident_vala__ : Ast_helper.str_vala
val xv_post_item_attributes_vala : Parsetree.attribute list Ast_helper.vala
val xv_post_item_attributes : Parsetree.attribute list
val xv_post_item_attribute : Parsetree.attribute
val xv_possibly_poly_type : Parsetree.core_type
...
val xv_poly_pattern : Parsetree.pattern
...
val xv_parse_structure : Parsetree.structure_item list Ast_helper.vala
val xv_parse_str_type_extension : Parsetree.type_extension
val xv_parse_signature_item : Parsetree.signature_item
val xv_parse_signature : Parsetree.signature_item list Ast_helper.vala
val xv_parse_sig_type_extension : Parsetree.type_extension
...
val xv_parse_longlident : Longident.t
val xv_parse_lident_vala_loc : Asttypes.label Ast_helper.vala Location.loc
...
val xv_parse_fun_seq_expr : Parsetree.expression
val xv_parse_fun_body : Parsetree.function_body
...
val xv_parse_attr_payload : Parsetree.payload
val xv_parse_attr_id : Ast_helper.str_vala
...
val xv_param_type : Parsetree.core_type
val xv_package_type_ : Parsetree.package_type
...
val xv_or_function_fun_seq_expr_ : Parsetree.expression
val xv_or_function_fun_expr_ : Parsetree.expression
...
val xv_option_vaval_type_constraint__ :
  Parsetree.type_constraint Ast_helper.vala option
val xv_option_type_constraint_ : Parsetree.type_constraint option
...
val xv_option_preceded_COLON_atomic_type__ : Parsetree.core_type option
val xv_option_preceded_AS_mkrhs_lident_vala___ : Ast_helper.str_vala option
...
val xv_operator : Asttypes.label
val xv_open_dot_declaration : Parsetree.open_declaration
val xv_open_description :
  Parsetree.open_description * string Ploc.vala Asttypes.loc option
val xv_open_declaration :
  Parsetree.open_declaration * string Ploc.vala Asttypes.loc option
val xv_op_infix_operator_ : Parsetree.expression
val xv_op___anonymous_25_ : Parsetree.expression
val xv_op_PREFIXOP_ : Parsetree.expression
val xv_op_HASHOP_ : Parsetree.expression
val xv_object_type : Parsetree.core_type
...
val xv_nonempty_type_kind :
  Parsetree.type_kind * Asttypes.private_flag Ast_helper.vala *
  Parsetree.core_type Ast_helper.vala option Ast_helper.vala
val xv_nonempty_llist_typevar_ :
  Asttypes.label Ast_helper.vala Asttypes.loc list
...
val xv_nonempty_list_mkrhs_lident_vala__ : string Ploc.vala Asttypes.loc list
val xv_nonempty_concat_fun_param_as_list_ : Parsetree.function_param list
...
val xv_mutable_virtual_flags :
  Asttypes.mutable_flag * Asttypes.virtual_flag Ast_helper.vala
...
val xv_module_type_subst :
  Parsetree.module_type_declaration * string Ploc.vala Asttypes.loc option
val xv_module_type_declaration :
  Parsetree.module_type_declaration * string Ploc.vala Asttypes.loc option
val xv_module_type : Parsetree.module_type
val xv_module_subst :
  Parsetree.module_substitution * string Ploc.vala Asttypes.loc option
val xv_module_name_ : Asttypes.label Ast_helper.vala option
val xv_module_name : Asttypes.label Ast_helper.vala option Ast_helper.vala
...
val xv_module_declaration :
  Parsetree.module_declaration * string Ploc.vala Asttypes.loc option
val xv_module_binding_body : Parsetree.module_expr
val xv_module_binding :
  Parsetree.module_binding * string Ploc.vala Asttypes.loc option
val xv_module_alias :
  Parsetree.module_declaration * string Ploc.vala Asttypes.loc option
val xv_mod_longident_vala : Longident.t Ast_helper.vala
val xv_mod_longident : Longident.t
val xv_mod_ext_longident_vala : Longident.t Ast_helper.vala
...
val xv_mktyp___anonymous_42_ : Parsetree.core_type
val xv_mktyp___anonymous_41_ : Parsetree.core_type
...
val xv_mktyp___anonymous_35_ : Parsetree.core_type
val xv_mktyp___anonymous_34_ : Parsetree.core_type
...
val xv_mkrhs_vala_val_longident_ANTI_LONGLID__ :
  Longident.t Ast_helper.vala Asttypes.loc
val xv_mkrhs_vala_type_longident_ANTI_LONGLID__ : Ast_helper.lid_vala
val xv_mkrhs_vala_mty_longident_ANTI_LONGID__ :
  Longident.t Ast_helper.vala Asttypes.loc
val xv_mkrhs_vala_mod_ext_longident_ANTI_LONGID__ :
  Longident.t Ast_helper.vala Asttypes.loc
val xv_mkrhs_vala_label_longident_ANTI_LONGLID__ :
  Longident.t Ast_helper.vala Asttypes.loc
...
val xv_mkrhs___anonymous_32_ : Longident.t Ast_helper.vala Asttypes.loc
val xv_mkrhs___anonymous_31_ : Longident.t Ast_helper.vala Asttypes.loc
val xv_mkrhs___anonymous_27_ : Longident.t Ast_helper.vala Asttypes.loc
val xv_mkrhs___anonymous_26_ : Longident.t Ast_helper.vala Asttypes.loc
val xv_mkrhs_UIDENT_ : string Asttypes.loc
val xv_mkrhs_LIDENT_ : string Location.loc
val xv_mkpat_simple_pattern_not_ident__ : Parsetree.pattern
val xv_mkpat___anonymous_33_ : Parsetree.pattern
val xv_mkpat___anonymous_30_ : Parsetree.pattern
val xv_mkpat___anonymous_29_ : Parsetree.pattern
val xv_mkpat___anonymous_28_pattern_no_exn__ : Parsetree.pattern
val xv_mkpat___anonymous_28_pattern__ : Parsetree.pattern
val xv_mkpat___anonymous_19_ : Parsetree.pattern
val xv_mkpat___anonymous_18_ : Parsetree.pattern
val xv_mkpat___anonymous_17_ : Parsetree.pattern
val xv_mkpat___anonymous_11_ : Parsetree.pattern
val xv_mkmty___anonymous_6_ : Parsetree.module_type
...
val xv_mkloc_lident_vala_ : Asttypes.label Ast_helper.vala Location.loc
val xv_mkloc___anonymous_44_ : Ast_helper.str_vala
val xv_mkexp_simple_expr__ : Parsetree.expression
val xv_mkexp_expr__ : Parsetree.expression
val xv_mkexp___anonymous_16_ : Parsetree.expression
val xv_mkcty___anonymous_14_ : Parsetree.class_type
val xv_mkcty___anonymous_13_ : Parsetree.class_type
val xv_mkctf___anonymous_15_ : Parsetree.class_type_field
val xv_mkclass___anonymous_9_ : Parsetree.class_expr
val xv_mkclass___anonymous_8_ : Parsetree.class_expr
val xv_mkclass___anonymous_7_ : Parsetree.class_expr
val xv_mkclass___anonymous_10_ : Parsetree.class_expr
val xv_mkcf___anonymous_12_ : Parsetree.class_field
val xv_mk_longident_mod_longident_vala_val_ident_vala_ : Longident.t
val xv_mk_longident_mod_longident_vala_uident_vala_ : Longident.t
val xv_mk_longident_mod_longident_vala_lident_vala_ : Longident.t
val xv_mk_longident_mod_ext_longident_vala_uident_vala_ : Longident.t
val xv_mk_longident_mod_ext_longident_vala_lident_vala_ : Longident.t
val xv_mk_longident_mod_ext_longident_vala_ident_vala_ : Longident.t
val xv_mk_longident_mod_ext_longident_vala___anonymous_43_ : Longident.t
...
val xv_metaocaml_expr : Parsetree.expression
...
val xv_local_structure_item : Parsetree.structure_item
...
val xv_lident_vala : Asttypes.label Ast_helper.vala
...
val xv_let_binding_body_no_punning :
  Parsetree.pattern * Parsetree.expression *
  Parsetree.value_constraint option
val xv_let_binding_body :
  Parsetree.pattern * Parsetree.expression *
  Parsetree.value_constraint option * bool
val xv_let_binding_no_ext_ : let_bindings
val xv_let_binding_ext_ : let_bindings
val xv_labeled_tuple_typ_element :
  Asttypes.label Ast_helper.vala option Ast_helper.vala * Parsetree.core_type
val xv_labeled_tuple_pattern_pattern_no_exn_ : Parsetree.pattern_desc
val xv_labeled_tuple_pattern_pattern_ : Parsetree.pattern_desc
val xv_labeled_tuple_pat_element_noprec_pattern_no_exn_ :
  Asttypes.label Ast_helper.vala option Ast_helper.vala * Parsetree.pattern
val xv_labeled_tuple_pat_element_noprec_pattern_ :
  Asttypes.label Ast_helper.vala option Ast_helper.vala * Parsetree.pattern
val xv_labeled_tuple_pat_element_list_pattern_no_exn_ :
  (Asttypes.label Ast_helper.vala option Ast_helper.vala * Parsetree.pattern)
  list
val xv_labeled_tuple_pat_element_list_pattern_ :
  (Asttypes.label Ast_helper.vala option Ast_helper.vala * Parsetree.pattern)
  list
val xv_labeled_tuple_pat_element_pattern_no_exn_ :
  Asttypes.label Ast_helper.vala option Ast_helper.vala * Parsetree.pattern
val xv_labeled_tuple_pat_element_pattern_ :
  Asttypes.label Ast_helper.vala option Ast_helper.vala * Parsetree.pattern
val xv_labeled_tuple_element :
  Asttypes.label Ast_helper.vala option Ast_helper.vala *
  Parsetree.expression
val xv_labeled_tuple :
  (Asttypes.label Ast_helper.vala option Ast_helper.vala *
   Parsetree.expression)
  list
val xv_labeled_simple_expr : Asttypes.arg_label * Parsetree.expression
val xv_label_var : string * Parsetree.pattern
val xv_label_vala : Asttypes.label Ast_helper.vala
...
val xv_ioption___anonymous_20_ : Longident.t Ast_helper.vala option
...
val xv_inline_separated_nonempty_llist_STAR_atomic_type_ :
  Parsetree.core_type list
val xv_inline_reversed_separated_nonempty_llist_STAR_labeled_tuple_typ_element_ :
  (Asttypes.label Ast_helper.vala option Ast_helper.vala *
   Parsetree.core_type)
  list
...
val xv_inline_reversed_separated_nonempty_llist_AMPERSAND_core_type_no_attr_ :
  Parsetree.core_type list
val xv_inline_private_flag_vala : Asttypes.private_flag Ast_helper.vala
...
val xv_indexop_expr_qualified_dotop_expr_semi_list___anonymous_24_ :
...
val xv_indexop_expr_qualified_dotop_expr_semi_list___anonymous_22_ :
  Parsetree.expression * (Longident.t Ast_helper.vala option * string) *
  paren_kind * Parsetree.expression list * Parsetree.expression option
val xv_indexop_expr_DOT_seq_expr___anonymous_23_ :
  Parsetree.expression * unit * paren_kind * Parsetree.expression *
  Parsetree.expression option
val xv_indexop_expr_DOT_seq_expr___anonymous_21_ :
  Parsetree.expression * unit * paren_kind * Parsetree.expression *
  Parsetree.expression option
...
val xv_include_statement_module_type_ :
  Parsetree.include_description * string Ploc.vala Asttypes.loc option
val xv_include_statement_module_expr_ :
  Parsetree.include_declaration * string Ploc.vala Asttypes.loc option
...
val xv_generic_constructor_declaration_epsilon_ :
  ...
  Parsetree.core_type option Ast_helper.vala * Ast_helper.attrs * Location.t
...
val xv_generalized_constructor_arguments :
  Asttypes.label Ast_helper.vala Asttypes.loc list Ast_helper.vala *
  Parsetree.constructor_arguments *
  Parsetree.core_type option Ast_helper.vala
val xv_functor_args :
  (Lexing.position * Parsetree.functor_parameter Ast_helper.vala) list
val xv_functor_arg :
  Lexing.position * Parsetree.functor_parameter Ast_helper.vala
val xv_function_type : Parsetree.core_type
val xv_fun_seq_expr : Parsetree.expression
val xv_fun_params : Parsetree.function_param list
val xv_fun_param_as_list : Parsetree.function_param list
val xv_fun_expr_attrs :
  Parsetree.expression_desc *
  (string Ploc.vala Asttypes.loc option * Ast_helper.attrs)
val xv_fun_expr : Parsetree.expression
val xv_fun_body : Parsetree.function_body
...
val xv_extra_rhs_param_type_ : Parsetree.core_type
...
val xv_extension_type : Parsetree.core_type
...
val xv_ext_attributes :
  string Ploc.vala Asttypes.loc option * Ast_helper.attrs
val xv_ext : string Ploc.vala Asttypes.loc option
...
val xv_epsilon : unit
val xv_do_done_expr : Parsetree.expression
val xv_direction_flag_vala : Asttypes.direction_flag Ast_helper.vala
val xv_direction_flag : Asttypes.direction_flag
val xv_delimited_type_supporting_local_open : Parsetree.core_type
val xv_delimited_type : Parsetree.core_type
...
val xv_class_type_declaration :
  string Ploc.vala Asttypes.loc option * Parsetree.class_type_declaration
...
val xv_class_description :
  string Ploc.vala Asttypes.loc option * Parsetree.class_description
val xv_class_declarations :
  string Ploc.vala Asttypes.loc option *
  Parsetree.class_declaration list Ast_helper.vala
val xv_class_declaration :
  string Ploc.vala Asttypes.loc option * Parsetree.class_declaration
...
val xv_bar_llist_constructor_declaration_ :
  Parsetree.constructor_declaration list
val xv_attributes_vala : Ast_helper.attrs
val xv_attributes : Parsetree.attribute list
val xv_attribute : Parsetree.attribute
val xv_attr_payload : Parsetree.payload
val xv_attr_id : Ast_helper.str_vala
val xv_atomic_type : Parsetree.core_type
val xv_arg_label_vala : Asttypes.arg_label Ast_helper.vala
val xv_arg_label_no_opt : Asttypes.arg_label
...
val xv___anonymous_7 : Parsetree.class_expr_desc
val xv___anonymous_6 : Parsetree.module_type_desc
val xv___anonymous_5 :
  Parsetree.signature_item_desc * string Ploc.vala Asttypes.loc option
val xv___anonymous_44 : string Ast_helper.vala
val xv___anonymous_43 : Asttypes.label Ast_helper.vala
val xv___anonymous_42 : Parsetree.core_type_desc
val xv___anonymous_41 : Parsetree.core_type_desc
...
val xv___anonymous_35 : Parsetree.core_type_desc
val xv___anonymous_34 : Parsetree.core_type_desc
val xv___anonymous_33 : Parsetree.pattern_desc
val xv___anonymous_32 : Longident.t Ast_helper.vala
val xv___anonymous_31 : Longident.t Ast_helper.vala
val xv___anonymous_30 : Parsetree.pattern_desc
val xv___anonymous_3 : Parsetree.module_expr_desc
val xv___anonymous_29 : Parsetree.pattern_desc
val xv___anonymous_28_pattern_no_exn_ : Parsetree.pattern_desc
val xv___anonymous_28_pattern_ : Parsetree.pattern_desc
val xv___anonymous_27 : Longident.t Ast_helper.vala
val xv___anonymous_26 : Longident.t Ast_helper.vala
val xv___anonymous_25 : string
...
val xv___anonymous_21 : Parsetree.expression option
val xv___anonymous_20 : Longident.t Ast_helper.vala
val xv___anonymous_2 :
  Parsetree.structure_item_desc * string Ploc.vala Asttypes.loc option
val xv___anonymous_19 : Parsetree.pattern_desc
val xv___anonymous_18 : Parsetree.pattern_desc
val xv___anonymous_17 : Parsetree.pattern_desc
val xv___anonymous_16 : Parsetree.expression_desc
val xv___anonymous_15 : Parsetree.class_type_field_desc
val xv___anonymous_14 : Parsetree.class_type_desc
val xv___anonymous_13 : Parsetree.class_type_desc
val xv___anonymous_12 : Parsetree.class_field_desc
val xv___anonymous_11 : Parsetree.pattern_desc
val xv___anonymous_10 : Parsetree.class_expr_desc
val xv___anonymous_1 :
  Parsetree.structure_item_desc * string Ploc.vala Asttypes.loc option

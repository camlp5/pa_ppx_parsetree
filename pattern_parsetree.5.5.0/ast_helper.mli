...
(*-*)    val attrs: core_type -> attrs -> core_type
    ...
    val arrow: ?loc:loc -> ?attrs:attrs -> arg_label Ploc.vala -> core_type -> core_type
               -> core_type
    val tuple: ?loc:loc -> ?attrs:attrs -> (string Ploc.vala option Ploc.vala * core_type) list Ploc.vala
               -> core_type
    ...
    val package_type: ?loc:loc -> ?attrs:attrs -> lid_vala -> (lid_vala * core_type) list Ploc.vala
      -> package_type
    (** @since 5.4 *)
  end
...
(*-*)    val attrs:pattern -> attributes -> pattern
    ...
    val tuple: ?loc:loc -> ?attrs:attrs -> (string Ploc.vala option Ploc.vala * pattern) list Ploc.vala
               -> closed_flag Ploc.vala -> pattern
...
(*-*)    val attrs: expression -> attrs -> expression
    ...
    val tuple: ?loc:loc -> ?attrs:attrs -> (string Ploc.vala option Ploc.vala * expression) list Ploc.vala
               -> expression
...
module Type:
  sig
    val mk: ?loc:loc -> ?attrs:attrs ->
      ...
      ?constraints:(core_type * core_type * loc) list Ploc.vala ->

...
let mk_indexop_expr array_indexing_operator ~loc
  ...
  let args = List.append [(Nolabel,array)] (List.append index set_arg) in
...
let pexp_extension ~loc ~id e = Pexp_extension (id, PStr [mkstrexp ~loc e []])
...
let mkexp_attrs ~loc desc (ext, attrs) =
  ...
  | Some id ->
     mkexp ~loc (pexp_extension ~loc ~id (ghexp ~loc ~attrs desc))
...
let extra_text startpos endpos text items =
  ...
  | [] ->
      ...
      List.append (text post) (text post_extras)
  | _ :: _ ->
      let pre_extras = rhs_pre_extra_text startpos in
      let post_extras = rhs_post_extra_text endpos in
        List.append (text pre_extras) (List.append items (text post_extras))
...
option_preceded_AS_mkrhs_LIDENT___:
    ...
    {( None )} [@name none_preceded_AS_mkrhs_LIDENT__]
| _1 = AS _1_inlined1 = LIDENT
  ...
  ( x )
in
( Some x )} [@name some_preceded_AS_mkrhs_LIDENT__]

option_preceded_COLON_atomic_type__:
  
    {( None )} [@name none_preceded_COLON_atomic_type_]
| _1 = COLON x = atomic_type
    {let x = ( x ) in
( Some x )} [@name some_preceded_COLON_atomic_type_]

option_preceded_COLON_core_type__:
  
    {( None )} [@name none_preceded_COLON_core_type_]
| _1 = COLON x = core_type
    {let x = ( x ) in
( Some x )} [@name some_preceded_COLON_core_type_]

option_preceded_EQUAL_expr__:
  
    {( None )} [@name none_preceded_EQUAL_expr_]
| _1 = EQUAL _1_inlined1 = fun_expr
    {let x =
  let x =
  ...
  ( x )
in
( Some x )} [@name some_preceded_EQUAL_expr_]
| _1 = EQUAL _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let x =
  let x =
    let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
    let _1 =
      let _3 =
        let xs =
      ...
      let _2 =
        let (_1, _1_inlined1) = (_1_inlined1, _1_inlined2) in
        let _2 =
          let _1 = _1_inlined1 in
          ( _1 )
        in
...
option_preceded_EQUAL_module_type__:
    ...
    {( None )} [@name none_preceded_EQUAL_module_type_]
| _1 = EQUAL x = module_type
    {let x = ( x ) in
( Some x )} [@name some_preceded_EQUAL_module_type_]

option_preceded_EQUAL_pattern__:
  
    {( None )} [@name none_preceded_EQUAL_pattern_]
| _1 = EQUAL x = pattern
    {let x = ( x ) in
( Some x )} [@name some_preceded_EQUAL_pattern_]

option_preceded_EQUAL_seq_expr__:
  
    {( None )} [@name none_preceded_EQUAL_seq_expr_]
| _1 = EQUAL x = seq_expr
    {let x = ( x ) in
( Some x )} [@name some_preceded_EQUAL_seq_expr_]

option_type_constraint_:
  
    {( None )} [@name none_type_constraint]
| x = type_constraint
    {( Some x )} [@name some_type_constraint]
...
in
( x :: xs )} [@name cons_and_class_declaration]
...
in
( x :: xs )} [@name cons_and_class_description]
...
in
( x :: xs )} [@name cons_and_class_type_declaration]
...
in
( x :: xs )} [@name cons_and_module_binding]
...
in
( x :: xs )} [@name cons_and_module_declaration]

list_attribute_:
  
    {( [] )} [@name nil_attribute]
| x = attribute xs = list_attribute_
    {( x :: xs )} [@name cons_attribute]
...
in
( x :: xs )} [@name cons_generic_and_type_declaration_type_kind_]
...
| _1 = SEMISEMI xs = list_signature_element_
  ...
  ( _1 )
in
( x :: xs )} [@name cons_signature_element]
| _1 = signature_item xs = list_signature_element_
    {let x =
  let _1 =
    let _startpos = _startpos__1_ in
    ( List.append (text_sig _startpos) [_1] )
  in
  ( _1 )
in
( x :: xs )} [@name cons_signature_element]
...
| _1 = SEMISEMI xs = list_structure_element_
  ...
  ( _1 )
in
( x :: xs )} [@name cons_structure_element]
      ...
      let items =
        let x =
          let _1 =
            ...
            let _startpos = _startpos__1_ in
            ( List.append (text_str _startpos) [_1] )
          in
          let _startpos__1_ = _startpos_e_ in
          let _endpos = _endpos__1_ in
          let _startpos = _startpos__1_ in
...
| _1 = class_sig_field xs = list_text_csig_class_sig_field__
    {let x =
  let _startpos = _startpos__1_ in
  ( List.append (text_csig _startpos) [_1] )
in
( x :: xs )} [@name cons_text_csig_class_sig_field_]
...
| _1 = class_field xs = list_text_cstr_class_field__
    {let x =
  let _startpos = _startpos__1_ in
  ( List.append (text_cstr _startpos) [_1] )
in
( x :: xs )} [@name cons_text_cstr_class_field_]
...
| _1 = structure_item xs = list_text_str_structure_item__
  ...
  ( List.append (text_str _startpos) [_1] )
in
( x :: xs )} [@name cons_text_str_structure_item_]
...
| _1 = SEMISEMI xs = list_use_file_element_
  ...
  ( _1 )
in
( x :: xs )} [@name cons_use_file_element]
    ...
    let x =
      ...
      let _1 =
        let x =
          ...
          let _startpos__1_ = _startpos_e_ in
          let _startpos = _startpos__1_ in
          ( List.append (text_def _startpos) [_1] )
        in
        ( x )
      in
      ( _1 )
...
| _1 = LIDENT xs = nonempty_list_mkrhs_LIDENT__
  ...
  ( mkrhs _1 _sloc )
in
( x :: xs )} [@name more_mkrhs_LIDENT_]

nonempty_list_raw_string_:
  s = STRING
    {let x = ( let body, _, _ = s in body ) in
( [ x ] )} [@name one_raw_string]
| s = STRING xs = nonempty_list_raw_string_
    {let x = ( let body, _, _ = s in body ) in
( x :: xs )} [@name more_raw_string]

reversed_llist_preceded_CONSTRAINT_constrain__:
  
    {( [] )}
| xs = reversed_llist_preceded_CONSTRAINT_constrain__ _1 = CONSTRAINT _1_inlined1 = alias_type _2 = EQUAL _1_inlined2 = alias_type
    {let x =
  let x =
    let (_endpos__1_inlined1_, _startpos__1_, _1, _1_inlined1) = (_endpos__1_inlined2_, _startpos__1_inlined1_, _1_inlined1, _1_inlined2) in
    let _3 =
      let _1 = _1_inlined1 in
      ( _1 )
    in
...
in
( [ x ] )}
| xs = reversed_nonempty_llist_typevar_ _1 = QUOTE _2 = ident
    {let x =
  let _endpos = _endpos__2_ in
  let _symbolstartpos = _startpos__1_ in
  let _sloc = (_symbolstartpos, _endpos) in
...
reversed_nonempty_concat_fun_param_as_list_:
  x = fun_param_as_list
    {( List.rev x )}
| xs = reversed_nonempty_concat_fun_param_as_list_ x = fun_param_as_list
...
reversed_separated_nonempty_llist_STAR_labeled_tuple_typ_element_:
  _1 = atomic_type %prec STAR
    {let xs =
  let x = ( None, _1 ) in
  ( [ x ] )
in
( xs )}
| label = LIDENT _2 = COLON ty = atomic_type %prec STAR
    {let xs =
  let x = ( Some label, ty ) in
  ( [ x ] )
in
( xs )}
| xs = reversed_separated_nonempty_llist_STAR_labeled_tuple_typ_element_ _2 = STAR _1 = atomic_type %prec STAR
    {let xs =
  let x = ( None, _1 ) in
  ( x :: xs )
in
( xs )}
| xs = reversed_separated_nonempty_llist_STAR_labeled_tuple_typ_element_ _2 = STAR label = LIDENT _2_inlined1 = COLON ty = atomic_type %prec STAR
    {let xs =
  let x = ( Some label, ty ) in
  ( x :: xs )
in
...
in
( [x] )} [@name none_SEMI]
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ x = SEMI
    {let _2 = ( Some x ) in
let x =
  let _1 =
    let _3 =
...
in
( [x] )} [@name some_SEMI]
| _1 = fun_expr _2 = SEMI xs = separated_or_terminated_nonempty_list_SEMI_expr_
    {let x =
  let _1 = ( _1 ) in
  ( _1 )
in
( x :: xs )}
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs_inlined1 = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _2 = SEMI xs = separated_or_terminated_nonempty_list_SEMI_expr_
    {let x =
...
in
( _1 )}
| me = module_expr _2 = LPAREN _3 = RPAREN
    {let _1 =
  let _1 = ( Pmod_apply_unit me ) in
...
| _1 = LPAREN _2 = VAL _1_inlined1 = list_attribute_ e = expr_colon_package_type _5 = RPAREN
    {let attrs =
  let _1 = _1_inlined1 in
  ( _1 )
in
...
| _1 = LPAREN _2 = VAL _1_inlined1 = list_attribute_ _1_inlined2 = fun_expr _5 = COLON _6 = error
    {let _4 =
  let _1 = _1_inlined2 in
  let _1 = ( _1 ) in
  ( _1 )
...
| _1 = LPAREN _2 = VAL _1_inlined1 = list_attribute_ _1_inlined2 = FUNCTION _1_inlined3 = ext _1_inlined4 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _5 = COLON _6 = error
    {let _4 =
  let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined2_, _1_inlined3, _1_inlined4) in
  let _1 =
    let _3 =
      let xs =
        let xs = ( List.rev xs ) in
...
let _loc__1_ = (_startpos__1_, _endpos__1_) in
( unclosed "(" _loc__1_ ")" _loc__6_ )}
| _1 = LPAREN _2 = VAL _1_inlined1 = list_attribute_ _1_inlined2 = fun_expr _5 = COLONGREATER _6 = error
    {let _4 =
  let _1 = _1_inlined2 in
  let _1 = ( _1 ) in
  ( _1 )
...
let _loc__1_ = (_startpos__1_, _endpos__1_) in
( unclosed "(" _loc__1_ ")" _loc__6_ )}
| _1 = LPAREN _2 = VAL _1_inlined1 = list_attribute_ _1_inlined2 = FUNCTION _1_inlined3 = ext _1_inlined4 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _5 = COLONGREATER _6 = error
    {let _4 =
  let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined2_, _1_inlined3, _1_inlined4) in
  let _1 =
    let _3 =
...
let _loc__1_ = (_startpos__1_, _endpos__1_) in
( unclosed "(" _loc__1_ ")" _loc__6_ )}
| _1 = LPAREN _2 = VAL _1_inlined1 = list_attribute_ _1_inlined2 = fun_expr _5 = error
    {let _4 =
  let _1 = _1_inlined2 in
  let _1 = ( _1 ) in
  ( _1 )
...
let _loc__1_ = (_startpos__1_, _endpos__1_) in
( unclosed "(" _loc__1_ ")" _loc__5_ )}
| _1 = LPAREN _2 = VAL _1_inlined1 = list_attribute_ _1_inlined2 = FUNCTION _1_inlined3 = ext _1_inlined4 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _5 = error
    {let _4 =
  let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined2_, _1_inlined3, _1_inlined4) in
  let _1 =
    let _3 =
...
in
( e )}
| _1 = fun_expr _2 = COLON _1_inlined1 = module_type
    {let ty =
  let (_endpos__1_, _startpos__1_, _1) = (_endpos__1_inlined1_, _startpos__1_inlined1_, _1_inlined1) in
  let _1 =
    let _endpos = _endpos__1_ in
...
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _2 = COLON _1_inlined3 = module_type
    {let ty =
...
let _loc = (_startpos, _endpos) in
( mkexp ~loc:_loc (Pexp_constraint (e, ty)) )}
| _1 = fun_expr _2 = COLON _1_inlined1 = module_type _4 = COLONGREATER _1_inlined2 = module_type
    {let ty2 =
  let (_endpos__1_, _startpos__1_, _1) = (_endpos__1_inlined2_, _startpos__1_inlined2_, _1_inlined2) in
  let _1 =
    let _endpos = _endpos__1_ in
...
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _2 = COLON _1_inlined3 = module_type _4 = COLONGREATER _1_inlined4 = module_type
    {let ty2 =
...
let _loc = (_startpos, _endpos) in
( mkexp ~loc:_loc (Pexp_coerce (e, Some ty1, ty2)) )}
| _1 = fun_expr _2 = COLONGREATER _1_inlined1 = module_type
    {let ty2 =
  let (_endpos__1_, _startpos__1_, _1) = (_endpos__1_inlined1_, _startpos__1_inlined1_, _1_inlined1) in
  let _1 =
    let _endpos = _endpos__1_ in
...
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _2 = COLONGREATER _1_inlined3 = module_type
    {let ty2 =
  let (_endpos__1_, _startpos__1_, _1) = (_endpos__1_inlined3_, _startpos__1_inlined3_, _1_inlined3) in
  let _1 =
    let _endpos = _endpos__1_ in
...
| _1 = reversed_nonempty_llist_functor_arg_ _2 = MINUSGREATER mty = module_type %prec below_WITH
    {let args = ( _1 ) in
...
| _1 = module_type_subst
    {let _1 =
  let _1 = ( psig_modtypesubst _1 ) in
  let _endpos = _endpos__1_ in
  let _symbolstartpos = _startpos__1_ in
  let _sloc = (_symbolstartpos, _endpos) in
  ( wrap_mksig_ext ~loc:_sloc _1 )
...
in
( _1 )}
| _1 = simple_param_pattern _2 = class_fun_binding
    {let _1 =
...
class_fun_def:
  _1 = simple_param_pattern _2 = MINUSGREATER e = class_expr
    {let _1 =
...
in
( _1 )}
| _1 = simple_param_pattern e = class_fun_def
    {let _1 =
  let _1 = ( let (l,o,p) = _1 in Pcl_fun(l, o, p, e) ) in
  let _endpos__1_ = _endpos_e_ in
  let _endpos = _endpos__1_ in
...
let _sloc = (_symbolstartpos, _endpos) in
( let docs = symbol_docs _sloc in
        mkcf ~loc:_sloc (Pcf_inherit (_2, _4, self)) ~attrs:(List.append _3 _6) ~docs )}
...
( let v, attrs = _2 in
        let docs = symbol_docs _sloc in
        mkcf ~loc:_sloc (Pcf_val v) ~attrs:(List.append attrs _3) ~docs )}
...
( let meth, attrs = _2 in
        let docs = symbol_docs _sloc in
        mkcf ~loc:_sloc (Pcf_method meth) ~attrs:(List.append attrs _3) ~docs )}
...
let _sloc = (_symbolstartpos, _endpos) in
( let docs = symbol_docs _sloc in
        mkcf ~loc:_sloc (Pcf_constraint _3) ~attrs:(List.append _2 _4) ~docs )}
...
let _sloc = (_symbolstartpos, _endpos) in
( let docs = symbol_docs _sloc in
        mkcf ~loc:_sloc (Pcf_initializer _3) ~attrs:(List.append _2 _4) ~docs )}
| _1 = item_extension _1_inlined1 = list_post_item_attribute_
    {let _2 =
  let _1 = _1_inlined1 in
  ( _1 )
...
let _sloc = (_symbolstartpos, _endpos) in
( let docs = symbol_docs _sloc in
        mkctf ~loc:_sloc (Pctf_inherit _3) ~attrs:(List.append _2 _4) ~docs )}
...
let _sloc = (_symbolstartpos, _endpos) in
( let docs = symbol_docs _sloc in
        mkctf ~loc:_sloc (Pctf_val _3) ~attrs:(List.append _2 _4) ~docs )}
...
( let (p, v) = _3 in
        let docs = symbol_docs _sloc in
        mkctf ~loc:_sloc (Pctf_method (_4, p, v, _6)) ~attrs:(List.append _2 _7) ~docs )}
| _1 = CONSTRAINT _1_inlined1 = list_attribute_ _3 = constrain_field _1_inlined2 = list_post_item_attribute_
    {let _4 =
  let _1 = _1_inlined2 in
  ( _1 )
...
let _sloc = (_symbolstartpos, _endpos) in
( let docs = symbol_docs _sloc in
        mkctf ~loc:_sloc (Pctf_constraint _3) ~attrs:(List.append _2 _4) ~docs )}
| _1 = item_extension _1_inlined1 = list_post_item_attribute_
    {let _2 =
  let _1 = _1_inlined1 in
  ( _1 )
...
fun_seq_expr:
  _1 = fun_expr %prec below_SEMI
    {( _1 )}
| _1 = fun_expr _2 = SEMI
    {( _1 )}
| _1 = fun_expr _2 = SEMI _3 = seq_expr
    {let _1 =
...
in
( _1 )}
| _1 = fun_expr _2 = SEMI _3 = PERCENT _4 = attr_id _5 = seq_expr
    {let _endpos = _endpos__5_ in
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
...
| _1 = simple_pattern
    {( (Nolabel, None, _1) )}
| _1 = LABEL _2 = LPAREN pat = pattern _2_inlined1 = COLON xs = reversed_nonempty_llist_typevar_ _2_inlined2 = DOT _3 = core_type _4 = RPAREN
    {let _3 =
  let _1 =
    let _1 =
      let cty =
...
in
( (Labelled _1, None, _3) )}
| _1 = LPAREN pat = pattern _2 = COLON xs = reversed_nonempty_llist_typevar_ _2_inlined1 = DOT _3_inlined1 = core_type _3 = RPAREN
    {let _2 =
...
in
( x )}
| _1 = LIDENT _2 = COLON _1_inlined1 = possibly_poly_core_type_
    {let cty =
  let _1 = _1_inlined1 in
  ( _1 )
in
...
let_pattern:
  _1 = pattern
    {( _1 )}
| _1 = pattern _2 = COLON _1_inlined1 = possibly_poly_core_type_
    {let _1 =
  let _1 =
    let _3 =
      let _1 = _1_inlined1 in
...
fun_expr:
  _1 = simple_expr %prec below_HASH
    {( _1 )}
| _1 = LET _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = local_structure_item _4 = IN _5 = seq_expr
    {let _1 =
  let _2 =
    let (_1, _1_inlined1) = (_1_inlined1, _1_inlined2) in
    let _2 =
...
| _1 = FUN _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = fun_params _4 = option_preceded_COLON_atomic_type__ _5 = MINUSGREATER _6 = fun_body
    {let _1 =
  let _2 =
    let (_1, _1_inlined1) = (_1_inlined1, _1_inlined2) in
    let _2 =
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = IF _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = seq_expr _4 = THEN _1_inlined3 = fun_expr _6 = ELSE _1_inlined4 = fun_expr
    {let _1 =
  let _7 =
    let _1 = _1_inlined4 in
    let _1 = ( _1 ) in
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = IF _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = seq_expr _4 = THEN _1_inlined3 = fun_expr _6 = ELSE _1_inlined4 = FUNCTION _1_inlined5 = ext _1_inlined6 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _7 =
    let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined4_, _1_inlined5, _1_inlined6) in
    let _1 =
      let _3 =
        let xs =
          let xs = ( List.rev xs ) in
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = IF _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = seq_expr _4 = THEN _1_inlined3 = FUNCTION _1_inlined4 = ext _1_inlined5 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _6 = ELSE _1_inlined6 = fun_expr
    {let _1 =
  let _7 =
  ...
  in
  let _5 =
    let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined3_, _1_inlined4, _1_inlined5) in
    let _1 =
      let _3 =
        let xs =
          let xs = ( List.rev xs ) in
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = IF _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = seq_expr _4 = THEN _1_inlined3 = FUNCTION _1_inlined4 = ext _1_inlined5 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _6 = ELSE _1_inlined6 = FUNCTION _1_inlined7 = ext _1_inlined8 = list_attribute_ xs_inlined1 = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _7 =
    let (_endpos_xs_, _startpos__1_, _1_inlined1, _1_inlined2, xs) = (_endpos_xs_inlined1_, _startpos__1_inlined6_, _1_inlined7, _1_inlined8, xs_inlined1) in
    let _1 =
      let _3 =
        let xs =
          let xs = ( List.rev xs ) in
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = IF _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = seq_expr _4 = THEN _1_inlined3 = fun_expr
    {let _1 =
  let _5 =
    let _1 = _1_inlined3 in
    let _1 = ( _1 ) in
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = IF _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = seq_expr _4 = THEN _1_inlined3 = FUNCTION _1_inlined4 = ext _1_inlined5 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _5 =
    let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined3_, _1_inlined4, _1_inlined5) in
    let _1 =
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = WHILE _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = seq_expr _1_inlined3 = DO e = seq_expr _3_inlined1 = DONE
    {let _1 =
  let _4 = ( e ) in
  let _2 =
    let (_1, _1_inlined1) = (_1_inlined1, _1_inlined2) in
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = WHILE _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = seq_expr _1_inlined3 = DO _2 = seq_expr _3_inlined1 = error
    {let _1 =
  let _4 =
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = FOR _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = pattern _4 = EQUAL _5 = seq_expr _6 = direction_flag _7 = seq_expr _1_inlined3 = DO e = seq_expr _3_inlined1 = DONE
    {let _1 =
  let _8 = ( e ) in
  let _2 =
    let (_1, _1_inlined1) = (_1_inlined1, _1_inlined2) in
...
( let desc, attrs = _1 in
        mkexp_attrs ~loc:_sloc desc attrs )}
| _1 = FOR _1_inlined1 = ext _1_inlined2 = list_attribute_ _3 = pattern _4 = EQUAL _5 = seq_expr _6 = direction_flag _7 = seq_expr _1_inlined3 = DO _2 = seq_expr _3_inlined1 = error
    {let _1 =
  let _8 =
    let (_endpos__1_, _startpos__1_) = (_endpos__1_inlined3_, _startpos__1_inlined3_) in
    let _loc__2_ = (_startpos__2_, _endpos__2_) in
...
in
( _1 )}
| xs = reversed_labeled_tuple_body %prec below_COMMA
    {let _1 =
  let _1 =
    let _1 =
      let xs = ( List.rev xs ) in
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP0 _1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = ( _1 ) in
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP0 _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let _1 =
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP1 _1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = ( _1 ) in
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP1 _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let _1 =
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP2 _1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = ( _1 ) in
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP2 _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let _1 =
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP3 _1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = ( _1 ) in
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP3 _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let _1 =
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP4 _1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = ( _1 ) in
...
in
( _1 )}
| e1 = fun_expr op = INFIXOP4 _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let _1 =
...
in
( _1 )}
| e1 = fun_expr _1 = PLUS _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = PLUS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = PLUSDOT _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = PLUSDOT _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = PLUSEQ _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = PLUSEQ _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = MINUS _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = MINUS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = MINUSDOT _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = MINUSDOT _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = STAR _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = STAR _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = PERCENT _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = PERCENT _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = EQUAL _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = EQUAL _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = LESS _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = LESS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = GREATER _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = GREATER _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = OR _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = OR _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = BARBAR _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = BARBAR _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = AMPERSAND _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = AMPERSAND _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = AMPERAMPER _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = AMPERAMPER _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| e1 = fun_expr _1 = COLONEQUAL _1_inlined1 = fun_expr
    {let _1 =
  let _1 =
    let e2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| e1 = fun_expr _1 = COLONEQUAL _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let _1 =
    let e2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| _1 = subtractive _1_inlined1 = fun_expr %prec prec_unary_minus
    {let _1 =
  let _1 =
    let _2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| _1 = subtractive _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ %prec prec_unary_minus
    {let _1 =
  let _1 =
    let _2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
in
( _1 )}
| _1 = additive _1_inlined1 = fun_expr %prec prec_unary_plus
    {let _1 =
  let _1 =
    let _2 =
      let _1 = _1_inlined1 in
...
in
( _1 )}
| _1 = additive _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ %prec prec_unary_plus
    {let _1 =
  let _1 =
    let _2 =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
| _1 = fun_expr _2 = COLONCOLON _1_inlined1 = fun_expr
    {let _3 =
  let _1 = _1_inlined1 in
  let _1 = ( _1 ) in
  ( _1 )
...
( mkexp_cons ~loc:_sloc _loc__2_
          (ghexp ~loc:_sloc (Pexp_tuple[None,_1;None,_3])) )}
| _1 = fun_expr _2 = COLONCOLON _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _3 =
  let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
  let _1 =
    let _3 =
...
( mkexp_cons ~loc:_sloc _loc__2_
          (ghexp ~loc:_sloc (Pexp_tuple[None,_1;None,_3])) )}
| _1 = LIDENT _2 = LESSMINUS _1_inlined1 = fun_expr
    {let _3 =
  let _1 = _1_inlined1 in
  let _1 = ( _1 ) in
  ( _1 )
...
| _1 = LIDENT _2 = LESSMINUS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _3 =
  let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
  let _1 =
    let _3 =
...
let _sloc = (_symbolstartpos, _endpos) in
( mkexp ~loc:_sloc (Pexp_setinstvar(_1, _3)) )}
| _1 = simple_expr _2 = DOT _1_inlined1 = label_longident _4 = LESSMINUS _1_inlined2 = fun_expr
    {let _5 =
  let _1 = _1_inlined2 in
  let _1 = ( _1 ) in
  ( _1 )
...
| _1 = simple_expr _2 = DOT _1_inlined1 = label_longident _4 = LESSMINUS _1_inlined2 = FUNCTION _1_inlined3 = ext _1_inlined4 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _5 =
  let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined2_, _1_inlined3, _1_inlined4) in
  let _1 =
    let _3 =
...
let _sloc = (_symbolstartpos, _endpos) in
( mkexp ~loc:_sloc (Pexp_setfield(_1, _3, _5)) )}
| array = simple_expr d = DOT _3 = LPAREN i = seq_expr _5 = RPAREN _1 = LESSMINUS _1_inlined1 = fun_expr
    {let _1 =
  let r =
    let v =
      let _1 = _1_inlined1 in
...
| array = simple_expr d = DOT _3 = LPAREN i = seq_expr _5 = RPAREN _1 = LESSMINUS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let r =
    let v =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr builtin_indexing_operators ~loc:_sloc _1 )}
| array = simple_expr d = DOT _3 = LBRACE i = seq_expr _5 = RBRACE _1 = LESSMINUS _1_inlined1 = fun_expr
    {let _1 =
  let r =
    let v =
      let _1 = _1_inlined1 in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr builtin_indexing_operators ~loc:_sloc _1 )}
| array = simple_expr d = DOT _3 = LBRACE i = seq_expr _5 = RBRACE _1 = LESSMINUS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let r =
    let v =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr builtin_indexing_operators ~loc:_sloc _1 )}
| array = simple_expr d = DOT _3 = LBRACKET i = seq_expr _5 = RBRACKET _1 = LESSMINUS _1_inlined1 = fun_expr
    {let _1 =
  let r =
    let v =
      let _1 = _1_inlined1 in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr builtin_indexing_operators ~loc:_sloc _1 )}
| array = simple_expr d = DOT _3 = LBRACKET i = seq_expr _5 = RBRACKET _1 = LESSMINUS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let r =
    let v =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr builtin_indexing_operators ~loc:_sloc _1 )}
| array = simple_expr _2 = DOTOP _3 = LPAREN es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RPAREN _1 = LESSMINUS _1_inlined1 = fun_expr
    {let _1 =
  let r =
    let v =
      let _1 = _1_inlined1 in
...
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name none___anonymous_20]
| array = simple_expr _2 = DOTOP _3 = LPAREN es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RPAREN _1 = LESSMINUS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let r =
    let v =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name none___anonymous_20]
| array = simple_expr _1 = DOT _2_inlined1 = mod_longident _2 = DOTOP _3 = LPAREN es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RPAREN _1_inlined1 = LESSMINUS _1_inlined2 = fun_expr
    {let _1 =
  let r =
...
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name some___anonymous_20]
| array = simple_expr _1 = DOT _2_inlined1 = mod_longident _2 = DOTOP _3 = LPAREN es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RPAREN _1_inlined1 = LESSMINUS _1_inlined2 = FUNCTION _1_inlined3 = ext _1_inlined4 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let r =
    let (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) = (_startpos__1_inlined2_, _1_inlined3, _1_inlined4) in
    let v =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
      let _1 =
        let _3 =
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name some___anonymous_20]
| array = simple_expr _2 = DOTOP _3 = LBRACE es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RBRACE _1 = LESSMINUS _1_inlined1 = fun_expr
    {let _1 =
  let r =
    let v =
      let _1 = _1_inlined1 in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name none___anonymous_20]
| array = simple_expr _2 = DOTOP _3 = LBRACE es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RBRACE _1 = LESSMINUS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let r =
    let v =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name none___anonymous_20]
| array = simple_expr _1 = DOT _2_inlined1 = mod_longident _2 = DOTOP _3 = LBRACE es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RBRACE _1_inlined1 = LESSMINUS _1_inlined2 = fun_expr
    {let _1 =
  let r =
    let _1_inlined1 = _1_inlined2 in
    let v =
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name some___anonymous_20]
| array = simple_expr _1 = DOT _2_inlined1 = mod_longident _2 = DOTOP _3 = LBRACE es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RBRACE _1_inlined1 = LESSMINUS _1_inlined2 = FUNCTION _1_inlined3 = ext _1_inlined4 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let r =
    let (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) = (_startpos__1_inlined2_, _1_inlined3, _1_inlined4) in
    let v =
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name some___anonymous_20]
| array = simple_expr _2 = DOTOP _3 = LBRACKET es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RBRACKET _1 = LESSMINUS _1_inlined1 = fun_expr
    {let _1 =
  let r =
    let v =
      let _1 = _1_inlined1 in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name none___anonymous_20]
| array = simple_expr _2 = DOTOP _3 = LBRACKET es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RBRACKET _1 = LESSMINUS _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let r =
    let v =
      let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name none___anonymous_20]
| array = simple_expr _1 = DOT _2_inlined1 = mod_longident _2 = DOTOP _3 = LBRACKET es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RBRACKET _1_inlined1 = LESSMINUS _1_inlined2 = fun_expr
    {let _1 =
  let r =
    let _1_inlined1 = _1_inlined2 in
    let v =
...
let _sloc = (_symbolstartpos, _endpos) in
( mk_indexop_expr user_indexing_operators ~loc:_sloc _1 )} [@name some___anonymous_20]
| array = simple_expr _1 = DOT _2_inlined1 = mod_longident _2 = DOTOP _3 = LBRACKET es = separated_or_terminated_nonempty_list_SEMI_expr_ _5 = RBRACKET _1_inlined1 = LESSMINUS _1_inlined2 = FUNCTION _1_inlined3 = ext _1_inlined4 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let _1 =
  let r =
    let (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) = (_startpos__1_inlined2_, _1_inlined3, _1_inlined4) in
    let v =
...
in
( _1 )} [@name some___anonymous_20]
| _1 = METAOCAML_ESCAPE e = simple_expr
    {let _1 =
  let _endpos = _endpos_e_ in
  let _symbolstartpos = _startpos__1_ in
  let _sloc = (_symbolstartpos, _endpos) in
  ( mkexp ~loc:_sloc (pexp_extension ~loc:_sloc ~id:(mknoloc "metaocaml.escape") e) )
in
( _1 )}
| _1 = METAOCAML_BRACKET_OPEN e = seq_expr _3 = METAOCAML_BRACKET_CLOSE
    {let _1 =
  let _endpos = _endpos__3_ in
  let _symbolstartpos = _startpos__1_ in
  let _sloc = (_symbolstartpos, _endpos) in
  ( mkexp ~loc:_sloc (pexp_extension ~loc:_sloc ~id:(mknoloc "metaocaml.bracket") e) )
in
( _1 )}
...
strict_binding:
  _1 = EQUAL _2 = seq_expr
    {( _2 )}
| _1 = fun_params _2 = option_type_constraint_ _3 = EQUAL _4 = fun_body
    {let _endpos = _endpos__4_ in
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
...
fun_param_as_list:
  _1 = LPAREN _2 = TYPE xs = nonempty_list_mkrhs_LIDENT__ _4 = RPAREN
    {let ty_params = ( xs ) in
let _endpos = _endpos__4_ in
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
...
fun_params:
  xs = reversed_nonempty_concat_fun_param_as_list_
    {let _1 =
  let xs = ( List.rev xs ) in
  ( xs )
in
...
reversed_labeled_tuple_body:
  xs = reversed_labeled_tuple_body _2 = COMMA _1 = fun_expr
    {let x =
  let _1 =
    let _1 = ( _1 ) in
    ( _1 )
...
in
( x :: xs )}
| xs = reversed_labeled_tuple_body _2 = COMMA _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs_inlined1 = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let x =
  let (_endpos_xs_, xs) = (_endpos_xs_inlined1_, xs_inlined1) in
  let _1 =
    let _1 =
...
in
( x :: xs )}
| xs = reversed_labeled_tuple_body _2 = COMMA _1 = LABEL _2_inlined1 = simple_expr %prec below_HASH
    {let x =
  let _2 = _2_inlined1 in
  ( Some _1, _2 )
in
( x :: xs )}
| xs = reversed_labeled_tuple_body _2 = COMMA _1 = TILDE label = LIDENT
    {let x =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
...
in
( x :: xs )}
| xs = reversed_labeled_tuple_body _2 = COMMA _1 = TILDE _2_inlined1 = LPAREN label = LIDENT c = type_constraint _5 = RPAREN %prec below_HASH
    {let x =
  let _startpos__2_ = _startpos__2_inlined1_ in
  let _endpos = _endpos__5_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( Some label,
...
in
( x :: xs )}
| _1 = fun_expr _2 = COMMA _1_inlined1 = fun_expr
    {let x2 =
  let _1 = _1_inlined1 in
  let _1 =
    let _1 = ( _1 ) in
...
in
( [ x2; None, x1 ] )}
| _1 = fun_expr _2 = COMMA _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let x2 =
  let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
  let _1 =
    let _1 =
...
in
( [ x2; None, x1 ] )}
| _1 = fun_expr _2 = COMMA _1_inlined1 = LABEL _2_inlined1 = simple_expr %prec below_HASH
    {let x2 =
  let (_1, _2) = (_1_inlined1, _2_inlined1) in
  ( Some _1, _2 )
in
let x1 =
  let _1 = ( _1 ) in
...
in
( [ x2; None, x1 ] )}
| _1 = fun_expr _2 = COMMA _1_inlined1 = TILDE label = LIDENT
    {let x2 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
       Some label, mkexpvar ~loc label )
...
in
( [ x2; None, x1 ] )}
| _1 = fun_expr _2 = COMMA _1_inlined1 = TILDE _2_inlined1 = LPAREN label = LIDENT c = type_constraint _5 = RPAREN %prec below_HASH
    {let x2 =
  let _startpos__2_ = _startpos__2_inlined1_ in
  let _endpos = _endpos__5_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
...
in
( [ x2; None, x1 ] )}
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _2 = COMMA _1_inlined3 = fun_expr
    {let x2 =
  let _1 = _1_inlined3 in
  let _1 =
    let _1 = ( _1 ) in
...
in
( [ x2; None, x1 ] )}
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _2 = COMMA _1_inlined3 = FUNCTION _1_inlined4 = ext _1_inlined5 = list_attribute_ xs_inlined1 = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let x2 =
  let (_endpos_xs_, _startpos__1_, _1_inlined1, _1_inlined2, xs) = (_endpos_xs_inlined1_, _startpos__1_inlined3_, _1_inlined4, _1_inlined5, xs_inlined1) in
  let _1 =
    let _1 =
      let _3 =
        let xs =
...
in
( [ x2; None, x1 ] )}
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _2 = COMMA _1_inlined3 = LABEL _2_inlined1 = simple_expr %prec below_HASH
    {let x2 =
  let (_1, _2) = (_1_inlined3, _2_inlined1) in
  ( Some _1, _2 )
in
let x1 =
  let _1 =
...
in
( [ x2; None, x1 ] )}
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _2 = COMMA _1_inlined3 = TILDE label = LIDENT
    {let x2 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
       Some label, mkexpvar ~loc label )
...
in
( [ x2; None, x1 ] )}
| _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_ _2 = COMMA _1_inlined3 = TILDE _2_inlined1 = LPAREN label = LIDENT c = type_constraint _5 = RPAREN %prec below_HASH
    {let x2 =
  let _startpos__2_ = _startpos__2_inlined1_ in
  let _endpos = _endpos__5_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
...
in
( [ x2; None, x1 ] )}
| l1 = LABEL x1 = simple_expr _3 = COMMA _1 = fun_expr
    {let x2 =
  let _1 =
    let _1 = ( _1 ) in
    ( _1 )
...
in
( [ x2; Some l1, x1 ] )}
| l1 = LABEL x1 = simple_expr _3 = COMMA _1 = FUNCTION _1_inlined1 = ext _1_inlined2 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let x2 =
  let _1 =
    let _1 =
      let _3 =
...
in
( [ x2; Some l1, x1 ] )}
| l1 = LABEL x1 = simple_expr _3 = COMMA _1 = LABEL _2 = simple_expr %prec below_HASH
    {let x2 = ( Some _1, _2 ) in
( [ x2; Some l1, x1 ] )}
| l1 = LABEL x1 = simple_expr _3 = COMMA _1 = TILDE label = LIDENT
    {let x2 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
       Some label, mkexpvar ~loc label )
in
( [ x2; Some l1, x1 ] )}
| l1 = LABEL x1 = simple_expr _3 = COMMA _1 = TILDE _2 = LPAREN label = LIDENT c = type_constraint _5 = RPAREN %prec below_HASH
    {let x2 =
  let _endpos = _endpos__5_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( Some label,
...
in
( [ x2; Some l1, x1 ] )}
| _1 = TILDE l1 = LIDENT _3 = COMMA _1_inlined1 = fun_expr
    {let x2 =
  let _1 = _1_inlined1 in
  let _1 =
    let _1 = ( _1 ) in
...
| _1 = TILDE l1 = LIDENT _3 = COMMA _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let x2 =
  let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
  let _1 =
    let _1 =
...
( let loc = _loc_l1_ in
    [ x2; Some l1, mkexpvar ~loc l1] )}
| _1 = TILDE l1 = LIDENT _3 = COMMA _1_inlined1 = LABEL _2 = simple_expr %prec below_HASH
    {let x2 =
  let _1 = _1_inlined1 in
  ( Some _1, _2 )
in
...
( let loc = _loc_l1_ in
    [ x2; Some l1, mkexpvar ~loc l1] )}
| _1 = TILDE l1 = LIDENT _3 = COMMA _1_inlined1 = TILDE label = LIDENT
    {let x2 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
       Some label, mkexpvar ~loc label )
...
( let loc = _loc_l1_ in
    [ x2; Some l1, mkexpvar ~loc l1] )}
| _1 = TILDE l1 = LIDENT _3 = COMMA _1_inlined1 = TILDE _2 = LPAREN label = LIDENT c = type_constraint _5 = RPAREN %prec below_HASH
    {let x2 =
  let _endpos = _endpos__5_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( Some label,
...
( let loc = _loc_l1_ in
    [ x2; Some l1, mkexpvar ~loc l1] )}
| _1 = TILDE _2 = LPAREN l1 = LIDENT c = type_constraint _5 = RPAREN _6 = COMMA _1_inlined1 = fun_expr
    {let x2 =
  let _1 = _1_inlined1 in
  let _1 =
    let _1 = ( _1 ) in
...
( let x1 =
    ...
    in
    [ x2; Some l1, x1] )}
| _1 = TILDE _2 = LPAREN l1 = LIDENT c = type_constraint _5 = RPAREN _6 = COMMA _1_inlined1 = FUNCTION _1_inlined2 = ext _1_inlined3 = list_attribute_ xs = reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
    {let x2 =
  let (_startpos__1_, _1_inlined1, _1_inlined2) = (_startpos__1_inlined1_, _1_inlined2, _1_inlined3) in
  let _1 =
    let _1 =
...
( let x1 =
    ...
    in
    [ x2; Some l1, x1] )}
| _1 = TILDE _2 = LPAREN l1 = LIDENT c = type_constraint _5 = RPAREN _6 = COMMA _1_inlined1 = LABEL _2_inlined1 = simple_expr %prec below_HASH
    {let x2 =
  let (_1, _2) = (_1_inlined1, _2_inlined1) in
  ( Some _1, _2 )
in
...
( let x1 =
    ...
    in
    [ x2; Some l1, x1] )}
| _1 = TILDE _2 = LPAREN l1 = LIDENT c = type_constraint _5 = RPAREN _6 = COMMA _1_inlined1 = TILDE label = LIDENT
    {let x2 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
       Some label, mkexpvar ~loc label )
...
( let x1 =
    ...
    in
    [ x2; Some l1, x1] )}
| _1 = TILDE _2 = LPAREN l1 = LIDENT c = type_constraint _5 = RPAREN _6 = COMMA _1_inlined1 = TILDE _2_inlined1 = LPAREN label = LIDENT c_inlined1 = type_constraint _5_inlined1 = RPAREN %prec below_HASH
    {let x2 =
  let (_endpos__5_, _startpos__2_, c) = (_endpos__5_inlined1_, _startpos__2_inlined1_, c_inlined1) in
  let _endpos = _endpos__5_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( Some label,
        mkexp_constraint ~loc:(_startpos__2_, _endpos)
...
record_expr_content:
  fields = separated_or_terminated_nonempty_list_SEMI_record_expr_field_
    {let eo = ( None ) in
( eo, fields )} [@name none_terminated_simple_expr_WITH_]
| x = simple_expr _2 = WITH fields = separated_or_terminated_nonempty_list_SEMI_record_expr_field_
    {let eo =
  let x = ( x ) in
  ( Some x )
in
( eo, fields )} [@name some_terminated_simple_expr_WITH_]
...
in
( _1 )}
| _1 = labeled_tuple_pattern_pattern_
    {let _1 =
  let _1 =
    let _1 = ( _1 ) in
    let _endpos = _endpos__1_ in
...
| _1 = EFFECT _2 = pattern_gen _3 = COMMA _4 = simple_pattern
    {let _endpos = _endpos__4_ in
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
...
in
( _1 )}
| _1 = labeled_tuple_pattern_pattern_no_exn_
    {let _1 =
  let _1 =
    let _1 = ( _1 ) in
    let _endpos = _endpos__1_ in
...
labeled_tuple_pat_element_list_pattern_:
  _1 = labeled_tuple_pat_element_list_pattern_ _2 = COMMA _1_inlined1 = pattern
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
( _3 :: _1 )}
| _1 = labeled_tuple_pat_element_list_pattern_ _2 = COMMA _1_inlined1 = LABEL _2_inlined1 = simple_pattern %prec COMMA
    {let _3 =
  let (_1, _2) = (_1_inlined1, _2_inlined1) in
  ( Some _1, _2 )
in
( _3 :: _1 )}
| _1 = labeled_tuple_pat_element_list_pattern_ _2 = COMMA _1_inlined1 = TILDE label = LIDENT
    {let _3 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
...
in
( _3 :: _1 )}
| _1 = labeled_tuple_pat_element_list_pattern_ _2 = COMMA _1_inlined1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN %prec COMMA
    {let _3 =
  let _startpos__2_ = _startpos__2_inlined1_ in
  let _endpos = _endpos__6_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let lbl_loc = _loc_label_ in
...
in
( _3 :: _1 )}
| _1 = pattern _2 = COMMA _1_inlined1 = pattern
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
let _1 = ( None, _1 ) in
( [ _3; _1 ] )}
| _1 = pattern _2 = COMMA _1_inlined1 = LABEL _2_inlined1 = simple_pattern %prec COMMA
    {let _3 =
  let (_1, _2) = (_1_inlined1, _2_inlined1) in
  ( Some _1, _2 )
in
let _1 = ( None, _1 ) in
( [ _3; _1 ] )}
| _1 = pattern _2 = COMMA _1_inlined1 = TILDE label = LIDENT
    {let _3 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
        Some label, mkpatvar ~loc label )
...
let _1 = ( None, _1 ) in
( [ _3; _1 ] )}
| _1 = pattern _2 = COMMA _1_inlined1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN %prec COMMA
    {let _3 =
  let _startpos__2_ = _startpos__2_inlined1_ in
  let _endpos = _endpos__6_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
...
let _1 = ( None, _1 ) in
( [ _3; _1 ] )}
| _1 = LABEL _2_inlined1 = simple_pattern _2 = COMMA _1_inlined1 = pattern
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
...
in
( [ _3; _1 ] )}
| _1 = LABEL _2_inlined1 = simple_pattern _2 = COMMA _1_inlined1 = LABEL _2_inlined2 = simple_pattern %prec COMMA
    {let _3 =
  let (_1, _2) = (_1_inlined1, _2_inlined2) in
  ( Some _1, _2 )
in
let _1 =
  let _2 = _2_inlined1 in
...
in
( [ _3; _1 ] )}
| _1 = LABEL _2_inlined1 = simple_pattern _2 = COMMA _1_inlined1 = TILDE label = LIDENT
    {let _3 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
        Some label, mkpatvar ~loc label )
...
in
( [ _3; _1 ] )}
| _1 = LABEL _2_inlined1 = simple_pattern _2 = COMMA _1_inlined1 = TILDE _2_inlined2 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN %prec COMMA
    {let _3 =
  let _startpos__2_ = _startpos__2_inlined2_ in
  let _endpos = _endpos__6_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let lbl_loc = _loc_label_ in
        let pat_loc = _startpos__2_, _endpos in
...
in
( [ _3; _1 ] )}
| _1 = TILDE label = LIDENT _2 = COMMA _1_inlined1 = pattern
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
...
in
( [ _3; _1 ] )}
| _1 = TILDE label = LIDENT _2 = COMMA _1_inlined1 = LABEL _2_inlined1 = simple_pattern %prec COMMA
    {let _3 =
  let (_1, _2) = (_1_inlined1, _2_inlined1) in
  ( Some _1, _2 )
in
...
in
( [ _3; _1 ] )}
| _1 = TILDE label = LIDENT _2 = COMMA _1_inlined1 = TILDE label_inlined1 = LIDENT
    {let _3 =
  let (_endpos_label_, _startpos_label_, label) = (_endpos_label_inlined1_, _startpos_label_inlined1_, label_inlined1) in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
        Some label, mkpatvar ~loc label )
in
...
in
( [ _3; _1 ] )}
| _1 = TILDE label = LIDENT _2 = COMMA _1_inlined1 = TILDE _2_inlined1 = LPAREN label_inlined1 = LIDENT _4 = COLON cty = core_type _6 = RPAREN %prec COMMA
    {let _3 =
  let (_endpos_label_, _startpos__2_, _startpos_label_, label) = (_endpos_label_inlined1_, _startpos__2_inlined1_, _startpos_label_inlined1_, label_inlined1) in
  let _endpos = _endpos__6_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let lbl_loc = _loc_label_ in
        let pat_loc = _startpos__2_, _endpos in
...
in
( [ _3; _1 ] )}
| _1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN _2 = COMMA _1_inlined1 = pattern
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
...
in
( [ _3; _1 ] )}
| _1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN _2 = COMMA _1_inlined1 = LABEL _2_inlined2 = simple_pattern %prec COMMA
    {let _3 =
  let (_1, _2) = (_1_inlined1, _2_inlined2) in
  ( Some _1, _2 )
in
...
in
( [ _3; _1 ] )}
| _1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN _2 = COMMA _1_inlined1 = TILDE label_inlined1 = LIDENT
    {let _3 =
  let (_endpos_label_, _startpos_label_, label) = (_endpos_label_inlined1_, _startpos_label_inlined1_, label_inlined1) in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
...
in
( [ _3; _1 ] )}
| _1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN _2 = COMMA _1_inlined1 = TILDE _2_inlined2 = LPAREN label_inlined1 = LIDENT _4_inlined1 = COLON cty_inlined1 = core_type _6_inlined1 = RPAREN %prec COMMA
    {let _3 =
  let (_endpos__6_, _endpos_label_, _startpos__2_, _startpos_label_, cty, label) = (_endpos__6_inlined1_, _endpos_label_inlined1_, _startpos__2_inlined2_, _startpos_label_inlined1_, cty_inlined1, label_inlined1) in
  let _endpos = _endpos__6_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let lbl_loc = _loc_label_ in
        let pat_loc = _startpos__2_, _endpos in
...
labeled_tuple_pat_element_list_pattern_no_exn_:
  _1 = labeled_tuple_pat_element_list_pattern_no_exn_ _2 = COMMA _1_inlined1 = pattern_no_exn
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
( _3 :: _1 )}
| _1 = labeled_tuple_pat_element_list_pattern_no_exn_ _2 = COMMA _1_inlined1 = LABEL _2_inlined1 = simple_pattern %prec COMMA
    {let _3 =
  let (_1, _2) = (_1_inlined1, _2_inlined1) in
  ( Some _1, _2 )
in
( _3 :: _1 )}
| _1 = labeled_tuple_pat_element_list_pattern_no_exn_ _2 = COMMA _1_inlined1 = TILDE label = LIDENT
    {let _3 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
        Some label, mkpatvar ~loc label )
in
( _3 :: _1 )}
| _1 = labeled_tuple_pat_element_list_pattern_no_exn_ _2 = COMMA _1_inlined1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN %prec COMMA
    {let _3 =
  let _startpos__2_ = _startpos__2_inlined1_ in
  let _endpos = _endpos__6_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
...
in
( _3 :: _1 )}
| _1 = pattern_no_exn _2 = COMMA _1_inlined1 = pattern_no_exn
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
let _1 = ( None, _1 ) in
( [ _3; _1 ] )}
| _1 = pattern_no_exn _2 = COMMA _1_inlined1 = LABEL _2_inlined1 = simple_pattern %prec COMMA
    {let _3 =
  let (_1, _2) = (_1_inlined1, _2_inlined1) in
  ( Some _1, _2 )
in
let _1 = ( None, _1 ) in
( [ _3; _1 ] )}
| _1 = pattern_no_exn _2 = COMMA _1_inlined1 = TILDE label = LIDENT
    {let _3 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
        Some label, mkpatvar ~loc label )
...
let _1 = ( None, _1 ) in
( [ _3; _1 ] )}
| _1 = pattern_no_exn _2 = COMMA _1_inlined1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN %prec COMMA
    {let _3 =
  let _startpos__2_ = _startpos__2_inlined1_ in
  let _endpos = _endpos__6_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
...
let _1 = ( None, _1 ) in
( [ _3; _1 ] )}
| _1 = LABEL _2_inlined1 = simple_pattern _2 = COMMA _1_inlined1 = pattern_no_exn
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
...
in
( [ _3; _1 ] )}
| _1 = TILDE label = LIDENT _2 = COMMA _1_inlined1 = pattern_no_exn
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
...
in
( [ _3; _1 ] )}
| _1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN _2 = COMMA _1_inlined1 = pattern_no_exn
    {let _3 =
  let _1 = _1_inlined1 in
  ( None, _1 )
in
...
reversed_labeled_tuple_pattern_pattern_:
  _1 = labeled_tuple_pat_element_list_pattern_ %prec below_COMMA
    {( Closed, _1 )}
| _1 = labeled_tuple_pat_element_list_pattern_ _2 = COMMA _3 = DOTDOT
    {( Open, _1 )}
| _1 = pattern _2 = COMMA _3 = DOTDOT
    {let _1 = ( None, _1 ) in
( Open, [ _1 ] )}
| _1 = LABEL _2_inlined1 = simple_pattern _2 = COMMA _3 = DOTDOT
    {let _1 =
  let _2 = _2_inlined1 in
  ( Some _1, _2 )
in
( Open, [ _1 ] )}
| _1 = TILDE label = LIDENT _2 = COMMA _3 = DOTDOT
    {let _1 =
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
  ( let loc = _loc_label_ in
        Some label, mkpatvar ~loc label )
in
( Open, [ _1 ] )}
| _1 = TILDE _2_inlined1 = LPAREN label = LIDENT _4 = COLON cty = core_type _6 = RPAREN _2 = COMMA _3 = DOTDOT
    {let _1 =
  let _startpos__2_ = _startpos__2_inlined1_ in
  let _endpos = _endpos__6_ in
  let _loc_label_ = (_startpos_label_, _endpos_label_) in
...
reversed_labeled_tuple_pattern_pattern_no_exn_:
  _1 = labeled_tuple_pat_element_list_pattern_no_exn_ %prec below_COMMA
    {( Closed, _1 )}
| _1 = labeled_tuple_pat_element_list_pattern_no_exn_ _2 = COMMA _3 = DOTDOT
    {( Open, _1 )}
| _1 = pattern_no_exn _2 = COMMA _3 = DOTDOT
    {let _1 = ( None, _1 ) in
( Open, [ _1 ] )}
| _1 = LABEL _2_inlined1 = simple_pattern _2 = COMMA _3 = DOTDOT
    {let _1 =
...
labeled_tuple_pattern_pattern_:
  _1 = reversed_labeled_tuple_pattern_pattern_
    {( let closed, pat = _1 in
        Ppat_tuple(List.rev pat, closed) )}

labeled_tuple_pattern_pattern_no_exn_:
  _1 = reversed_labeled_tuple_pattern_pattern_no_exn_
    {( let closed, pat = _1 in
        Ppat_tuple(List.rev pat, closed) )}
...
let oty =
  ...
  ( _1 )
in
( (Ptype_variant cs, priv, oty) )} [@name none_terminated_core_type_EQUAL_]
...
let oty =
  ...
  ( _1 )
in
( (Ptype_variant cs, priv, oty) )} [@name some_terminated_core_type_EQUAL_]
...
let oty =
  ...
  ( _1 )
in
( (Ptype_open, priv, oty) )} [@name none_terminated_core_type_EQUAL_]
...
let oty =
  ...
  ( _1 )
in
( (Ptype_open, priv, oty) )} [@name some_terminated_core_type_EQUAL_]
...
let oty =
  ...
  ( _1 )
in
( (Ptype_record ls, priv, oty) )} [@name none_terminated_core_type_EQUAL_]
...
let oty =
  ...
  ( _1 )
in
( (Ptype_record ls, priv, oty) )} [@name some_terminated_core_type_EQUAL_]
...
in
( (Ptype_record ls, priv, oty) )} [@name some_terminated_core_type_EQUAL_]
| _1 = EXTERNAL s = STRING
    {let name = ( let body, _, _ = s in body ) in
...
( if _1 = "+!" then Covariant, Injective else
        ...
        if _1 = "+-" then Bivariant, NoInjectivity else
        if _1 = "-+" then Bivariant, NoInjectivity else
...
( let vars, args, res = vars_args_res in
      ...
      let docs = symbol_docs _sloc in
      Te.mk_exception ~attrs ~loc
        (Te.decl id ~vars ~args ~res ~attrs:(List.append attrs1 attrs2) ~loc ~docs)
      , ext )}
...
( let info =
       ...
       in
       Type.field _2 _4 ~mut:_1 ~attrs:(List.append _5 _7) ~loc:(make_loc _sloc) ~info )}
...
alias_type:
  _1 = function_type
    {( _1 )}
| ty = alias_type _2 = AS _1 = QUOTE _2_inlined1 = ident
    {let _1 =
  let _1 =
    let tyvar =
...
function_type:
  ty = tuple_type %prec MINUSGREATER
    {( ty )}
| label = optlabel _1 = LPAREN xs = reversed_nonempty_llist_typevar_ _2 = DOT _3_inlined1 = core_type _3_inlined2 = RPAREN _3 = MINUSGREATER codomain = function_type
    {let _1 =
  let _1 =
    let domain =
      let _endpos__3_ = _endpos__3_inlined2_ in
      let _1 =
        let _2 =
          let (_endpos__3_, _3) = (_endpos__3_inlined1_, _3_inlined1) in
          let _1 =
...
in
( _1 )}
| label = optlabel ty = tuple_type _3 = MINUSGREATER codomain = function_type
    {let _1 =
  let _1 =
    let domain =
      let _1 = ( ty ) in
...
in
( _1 )}
| label = LIDENT _2 = COLON _1 = LPAREN xs = reversed_nonempty_llist_typevar_ _2_inlined1 = DOT _3_inlined1 = core_type _3_inlined2 = RPAREN _3 = MINUSGREATER codomain = function_type
    {let _1 =
  let _1 =
    let domain =
      let _endpos__3_ = _endpos__3_inlined2_ in
...
in
( _1 )}
| label = LIDENT _2 = COLON ty = tuple_type _3 = MINUSGREATER codomain = function_type
    {let _1 =
  let _1 =
    let domain =
      let _1 = ( ty ) in
...
in
( _1 )}
| _1 = LPAREN xs = reversed_nonempty_llist_typevar_ _2 = DOT _3_inlined1 = core_type _3_inlined2 = RPAREN _3 = MINUSGREATER codomain = function_type
    {let _1 =
  let _1 =
    let domain =
      let _endpos__3_ = _endpos__3_inlined2_ in
...
in
( _1 )}
| ty = tuple_type _3 = MINUSGREATER codomain = function_type
    {let _1 =
  let _1 =
    let domain =
      let _1 = ( ty ) in
...
in
( _1 )}
| label = LIDENT _2 = COLON ty = atomic_type _2_inlined1 = STAR xs = reversed_separated_nonempty_llist_STAR_labeled_tuple_typ_element_ _4 = MINUSGREATER codomain = function_type
    {let _1 =
  let _1 =
    let tuple =
      let ltys =
...
in
( _1 )}
| label = LIDENT _2 = COLON ty = atomic_type _2_inlined1 = STAR xs = reversed_separated_nonempty_llist_STAR_labeled_tuple_typ_element_ %prec MINUSGREATER
    {let _3 =
  let ltys =
    let xs = ( List.rev xs ) in
    ( xs )
...
let _sloc = (_symbolstartpos, _endpos) in
( let ty, ltys = _3 in
      mktyp ~loc:_sloc (Ptyp_tuple ((Some label, ty) :: ltys))
    )}
| label = LIDENT _2_inlined1 = COLON _2 = LPAREN _3 = MODULE _1 = ext _1_inlined1 = list_attribute_ _1_inlined2 = UIDENT _6 = COLON _1_inlined3 = module_type _8 = RPAREN _9 = MINUSGREATER codomain = function_type
    {let _1 =
  let _1 =
    let ptyp =
      let (_endpos__1_, _startpos__1_, _1) = (_endpos__1_inlined3_, _startpos__1_inlined3_, _1_inlined3) in
    ...
    ( let ptyp = {ptyp with ppt_attrs = List.append (snd attrs) ptyp.ppt_attrs } in
...
in
( _1 )}
| _2 = LPAREN _3 = MODULE _1 = ext _1_inlined1 = list_attribute_ _1_inlined2 = UIDENT _6 = COLON _1_inlined3 = module_type _8 = RPAREN _9 = MINUSGREATER codomain = function_type
    {let _1 =
  let _1 =
    let ptyp =
      let (_endpos__1_, _startpos__1_, _1) = (_endpos__1_inlined3_, _startpos__1_inlined3_, _1_inlined3) in
...
tuple_type:
  ty = atomic_type %prec below_HASH
    {( ty )}
| ty = atomic_type _2 = STAR xs = reversed_separated_nonempty_llist_STAR_labeled_tuple_typ_element_ %prec below_WITH
    {let _1 =
  let ltys =
    let xs = ( List.rev xs ) in
    ( xs )
...
delimited_type_supporting_local_open:
  _1 = LPAREN type_ = core_type _3 = RPAREN
    {( type_ )}
...
| _1 = LBRACKET field = tag_field _3 = RBRACKET
    {let _1 =
  let _1 = ( Ptyp_variant([ field ], Closed, None) ) in
  let _endpos__1_ = _endpos__3_ in
  let _endpos = _endpos__1_ in
  let _symbolstartpos = _startpos__1_ in
  let _sloc = (_symbolstartpos, _endpos) in
...
in
( _1 )}
| _1 = LBRACKET field = row_field _3 = BAR xs = reversed_separated_nonempty_llist_BAR_row_field_ _5 = RBRACKET
    {let _1 =
  let _1 =
    let fields =
      let _1 =
...
object_type:
  _1 = LESS meth_list = meth_list _3 = GREATER
    {let _1 =
  let _1 = ( let (f, c) = meth_list in Ptyp_object (f, c) ) in
  let _endpos__1_ = _endpos__3_ in
  let _endpos = _endpos__1_ in
  let _symbolstartpos = _startpos__1_ in
  let _sloc = (_symbolstartpos, _endpos) in
...
| _1 = extension_type
    {( _1 )}
| _1 = delimited_type_supporting_local_open
    {( _1 )}
...
in
( _1 )}
| _1 = mod_ext_longident _2 = DOT type_ = delimited_type_supporting_local_open
    {let _1 =
  let _1 =
    let mod_ident =
      let _endpos = _endpos__1_ in
...
in
( _1 )}
| _1 = QUOTE ident = ident
    {let _1 =
  let _1 = ( Ptyp_var ident ) in
...
meth_list:
  ...
  ( let info =
        ...
        | None -> symbol_info _endpos
      in
      let attrs = add_info_attrs info (List.append _4 _6) in
...
mk_longident_mod_ext_longident___anonymous_43_:
  _1 = ident
    {let _1 = ( _1 ) in
( Lident _1 )}
| _1 = LPAREN _2 = COLONCOLON _3 = RPAREN
...
any_longident:
  _1 = mk_longident_mod_ext_longident___anonymous_43_
    {( _1 )}
| _1 = constr_extra_nonprefix_ident
    {( Lident _1 )}
...
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
( mk_directive ~loc:_sloc dir arg )} [@name none_mk_directive_arg_toplevel_directive_argument_]
...
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
( mk_directive ~loc:_sloc dir arg )} [@name some_mk_directive_arg_toplevel_directive_argument_]
...
attribute:
  _1 = LBRACKETAT _2 = attr_id _3 = attr_payload _4 = RBRACKET
    {let _endpos = _endpos__4_ in
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
...
post_item_attribute:
  _1 = LBRACKETATAT _2 = attr_id _3 = attr_payload _4 = RBRACKET
    {let _endpos = _endpos__4_ in
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in
( mk_attr ~loc:(make_loc _sloc) _2 _3 )}
...
floating_attribute:
  _1 = LBRACKETATATAT _2 = attr_id _3 = attr_payload _4 = RBRACKET
    {let _endpos = _endpos__4_ in
let _symbolstartpos = _startpos__1_ in
let _sloc = (_symbolstartpos, _endpos) in

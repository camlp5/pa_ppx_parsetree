...
(*-*)  | Ptyp_xtr of string loc
  ...
  | Ptyp_arrow of arg_label Ploc.vala * core_type * core_type
      (** [Ptyp_arrow(lbl, T1, T2)] represents:
         ...
         *)
  | Ptyp_tuple of (string Ploc.vala option Ploc.vala * core_type) list Ploc.vala
...
and package_type =
    {
     ppt_path: Longident.t Ploc.vala loc;
     ppt_constraints: (Longident.t Ploc.vala loc * core_type) list Ploc.vala;
     ppt_loc: Location.t;
...
(*-*)  | Ppat_xtr of string loc
  ...
  | Ppat_tuple of (string Ploc.vala option Ploc.vala * pattern) list Ploc.vala * Asttypes.closed_flag Ploc.vala
...
(*-*)  | Pexp_xtr of string loc
  ...
  *)
  ...
  | Pexp_tuple of (string Ploc.vala option Ploc.vala * expression) list Ploc.vala
...
and type_declaration =
    {
     ...
     ptype_params: (core_type * (variance * injectivity)) list Ploc.vala;
      (** [('a1,...'an) t] *)
     ptype_constraints: (core_type * core_type * Location.t) list Ploc.vala;
